...
namespace App\Models\TicketPricing;
...
class FareRule extends Model
{
    ...
    {
        // Scope: withPriorityAbove for FareRule
    ...
    {
        // Scope: recentlyUpdated for FareRule
    ...
    {
        // Scope: pendingReview for FareRule
    ...
    {
        // Scope: byExternalRef for FareRule
    ...
    {
        // Scope: effectiveOn for FareRule
    ...
    {
        // Scope: overlappingPeriod for FareRule
    ...
    {
        // Scope: withMetadataKey for FareRule
    ...
    {
        // Scope: highPriority for FareRule
    ...
    {
        // Scope: lowPriority for FareRule
    ...
    {
        // Scope: searchByName for FareRule
    ...
    {
        // Scope: searchByCode for FareRule
    ...
    {
        // Scope: orderedByPriority for FareRule
    ...
    {
        // Scope: orderedByCode for FareRule
    ...
    {
        // Scope: withoutNotes for FareRule
    ...
    {
        // Scope: latestVersion for FareRule
    ...
    {
        // Scope: forDateRange for FareRule
    ...
    {
        // Scope: createdAfter for FareRule
    ...
    {
        // Scope: createdBefore for FareRule
    ...
    {
        // Scope: updatedAfter for FareRule
    ...
    {
        // Scope: updatedBefore for FareRule
    ...
    {
        // Scope: withCreator for FareRule
    ...
    {
        // Scope: withUpdater for FareRule
