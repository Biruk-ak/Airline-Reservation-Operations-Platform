...
namespace App\Models\WeatherIntegration;
...
class WeatherObservation extends Model
{
    ...
    protected $table = 'weather_integration';
    ...
    {
        // Scope: active for WeatherObservation
    ...
    {
        // Scope: inactive for WeatherObservation
    ...
    {
        // Scope: forAirline for WeatherObservation
    ...
    {
        // Scope: forStation for WeatherObservation
    ...
    {
        // Scope: forRegion for WeatherObservation
    ...
    {
        // Scope: withPriorityAbove for WeatherObservation
    ...
    {
        // Scope: recentlyUpdated for WeatherObservation
    ...
    {
        // Scope: pendingReview for WeatherObservation
    ...
    {
        // Scope: archived for WeatherObservation
    ...
    {
        // Scope: scheduled for WeatherObservation
    ...
    {
        // Scope: inProgress for WeatherObservation
    ...
    {
        // Scope: completed for WeatherObservation
    ...
    {
        // Scope: cancelled for WeatherObservation
    ...
    {
        // Scope: byExternalRef for WeatherObservation
    ...
    {
        // Scope: byCode for WeatherObservation
    ...
    {
        // Scope: effectiveOn for WeatherObservation
    ...
    {
        // Scope: overlappingPeriod for WeatherObservation
    ...
    {
        // Scope: ownedBy for WeatherObservation
    ...
    {
        // Scope: withMetadataKey for WeatherObservation
    ...
    {
        // Scope: highPriority for WeatherObservation
    ...
    {
        // Scope: lowPriority for WeatherObservation
    ...
    {
        // Scope: searchByName for WeatherObservation
    ...
    {
        // Scope: searchByCode for WeatherObservation
    ...
    {
        // Scope: orderedByPriority for WeatherObservation
    ...
    {
        // Scope: orderedByCode for WeatherObservation
    ...
    {
        // Scope: withNotes for WeatherObservation
    ...
    {
        // Scope: withoutNotes for WeatherObservation
    ...
    {
        // Scope: versioned for WeatherObservation
    ...
    {
        // Scope: latestVersion for WeatherObservation
    ...
    {
        // Scope: forDateRange for WeatherObservation
    ...
    {
        // Scope: createdAfter for WeatherObservation
    ...
    {
        // Scope: createdBefore for WeatherObservation
    ...
    {
        // Scope: updatedAfter for WeatherObservation
    ...
    {
        // Scope: updatedBefore for WeatherObservation
    ...
    {
        // Scope: withCreator for WeatherObservation
    ...
    {
        // Scope: withUpdater for WeatherObservation
    ...
    {
        // Scope: bulkActive for WeatherObservation
