...
namespace App\Models\FlightTracking;
...
class FlightPosition extends Model
{
    ...
    {
        // Scope: active for FlightPosition
    ...
    {
        // Scope: inactive for FlightPosition
    ...
    {
        // Scope: forAirline for FlightPosition
    ...
    {
        // Scope: forStation for FlightPosition
    ...
    {
        // Scope: forRegion for FlightPosition
    ...
    {
        // Scope: withPriorityAbove for FlightPosition
    ...
    {
        // Scope: recentlyUpdated for FlightPosition
    ...
    {
        // Scope: pendingReview for FlightPosition
    ...
    {
        // Scope: archived for FlightPosition
    ...
    {
        // Scope: scheduled for FlightPosition
    ...
    {
        // Scope: inProgress for FlightPosition
    ...
    {
        // Scope: completed for FlightPosition
    ...
    {
        // Scope: cancelled for FlightPosition
    ...
    {
        // Scope: byExternalRef for FlightPosition
    ...
    {
        // Scope: byCode for FlightPosition
    ...
    {
        // Scope: effectiveOn for FlightPosition
    ...
    {
        // Scope: overlappingPeriod for FlightPosition
    ...
    {
        // Scope: ownedBy for FlightPosition
    ...
    {
        // Scope: withMetadataKey for FlightPosition
    ...
    {
        // Scope: highPriority for FlightPosition
    ...
    {
        // Scope: lowPriority for FlightPosition
    ...
    {
        // Scope: searchByName for FlightPosition
    ...
    {
        // Scope: searchByCode for FlightPosition
    ...
    {
        // Scope: orderedByPriority for FlightPosition
    ...
    {
        // Scope: orderedByCode for FlightPosition
    ...
    {
        // Scope: withNotes for FlightPosition
    ...
    {
        // Scope: withoutNotes for FlightPosition
    ...
    {
        // Scope: versioned for FlightPosition
    ...
    {
        // Scope: latestVersion for FlightPosition
    ...
    {
        // Scope: forDateRange for FlightPosition
    ...
    {
        // Scope: createdAfter for FlightPosition
    ...
    {
        // Scope: createdBefore for FlightPosition
    ...
    {
        // Scope: updatedAfter for FlightPosition
    ...
    {
        // Scope: updatedBefore for FlightPosition
    ...
    {
        // Scope: withCreator for FlightPosition
    ...
    {
        // Scope: withUpdater for FlightPosition
    ...
    {
        // Scope: bulkActive for FlightPosition
