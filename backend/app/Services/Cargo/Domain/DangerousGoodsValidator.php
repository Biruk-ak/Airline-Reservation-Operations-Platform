...
namespace App\Services\Cargo\Domain;
...
/**
 * Domain service: DangerousGoodsValidator
 * Module: Cargo
 *
 * Encapsulates operational workflows for airline Cargo processes.
 */
class DangerousGoodsValidator
{
    ...
    public function execute(array $context = []): array
    {
        ...
        $this->logger->info('DangerousGoodsValidator.execute.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.Cargo.DangerousGoodsValidator.execute.success');

            return $this->success('execute', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('DangerousGoodsValidator.execute.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.Cargo.DangerousGoodsValidator.execute.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('DangerousGoodsValidator.validate.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.Cargo.DangerousGoodsValidator.validate.success');

            return $this->success('validate', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('DangerousGoodsValidator.validate.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.Cargo.DangerousGoodsValidator.validate.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('DangerousGoodsValidator.simulate.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.Cargo.DangerousGoodsValidator.simulate.success');

            return $this->success('simulate', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('DangerousGoodsValidator.simulate.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.Cargo.DangerousGoodsValidator.simulate.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('DangerousGoodsValidator.reconcile.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.Cargo.DangerousGoodsValidator.reconcile.success');

            return $this->success('reconcile', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('DangerousGoodsValidator.reconcile.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.Cargo.DangerousGoodsValidator.reconcile.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('DangerousGoodsValidator.optimize.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.Cargo.DangerousGoodsValidator.optimize.success');

            return $this->success('optimize', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('DangerousGoodsValidator.optimize.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.Cargo.DangerousGoodsValidator.optimize.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('DangerousGoodsValidator.forecast.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.Cargo.DangerousGoodsValidator.forecast.success');

            return $this->success('forecast', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('DangerousGoodsValidator.forecast.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.Cargo.DangerousGoodsValidator.forecast.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('DangerousGoodsValidator.publish.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.Cargo.DangerousGoodsValidator.publish.success');

            return $this->success('publish', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('DangerousGoodsValidator.publish.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.Cargo.DangerousGoodsValidator.publish.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('DangerousGoodsValidator.rollback.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.Cargo.DangerousGoodsValidator.rollback.success');

            return $this->success('rollback', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('DangerousGoodsValidator.rollback.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.Cargo.DangerousGoodsValidator.rollback.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('DangerousGoodsValidator.snapshot.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.Cargo.DangerousGoodsValidator.snapshot.success');

            return $this->success('snapshot', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('DangerousGoodsValidator.snapshot.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.Cargo.DangerousGoodsValidator.snapshot.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('DangerousGoodsValidator.diff.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.Cargo.DangerousGoodsValidator.diff.success');

            return $this->success('diff', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('DangerousGoodsValidator.diff.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.Cargo.DangerousGoodsValidator.diff.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('DangerousGoodsValidator.enrich.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.Cargo.DangerousGoodsValidator.enrich.success');

            return $this->success('enrich', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('DangerousGoodsValidator.enrich.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.Cargo.DangerousGoodsValidator.enrich.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('DangerousGoodsValidator.normalize.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.Cargo.DangerousGoodsValidator.normalize.success');

            return $this->success('normalize', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('DangerousGoodsValidator.normalize.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.Cargo.DangerousGoodsValidator.normalize.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('DangerousGoodsValidator.aggregate.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.Cargo.DangerousGoodsValidator.aggregate.success');

            return $this->success('aggregate', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('DangerousGoodsValidator.aggregate.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.Cargo.DangerousGoodsValidator.aggregate.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('DangerousGoodsValidator.dispatch.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.Cargo.DangerousGoodsValidator.dispatch.success');

            return $this->success('dispatch', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('DangerousGoodsValidator.dispatch.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.Cargo.DangerousGoodsValidator.dispatch.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('DangerousGoodsValidator.acknowledge.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.Cargo.DangerousGoodsValidator.acknowledge.success');

            return $this->success('acknowledge', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('DangerousGoodsValidator.acknowledge.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.Cargo.DangerousGoodsValidator.acknowledge.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('DangerousGoodsValidator.escalate.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.Cargo.DangerousGoodsValidator.escalate.success');

            return $this->success('escalate', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('DangerousGoodsValidator.escalate.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.Cargo.DangerousGoodsValidator.escalate.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('DangerousGoodsValidator.suppress.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.Cargo.DangerousGoodsValidator.suppress.success');

            return $this->success('suppress', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('DangerousGoodsValidator.suppress.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.Cargo.DangerousGoodsValidator.suppress.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('DangerousGoodsValidator.replay.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.Cargo.DangerousGoodsValidator.replay.success');

            return $this->success('replay', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('DangerousGoodsValidator.replay.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.Cargo.DangerousGoodsValidator.replay.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('DangerousGoodsValidator.hydrate.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.Cargo.DangerousGoodsValidator.hydrate.success');

            return $this->success('hydrate', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('DangerousGoodsValidator.hydrate.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.Cargo.DangerousGoodsValidator.hydrate.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('DangerousGoodsValidator.persist.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.Cargo.DangerousGoodsValidator.persist.success');

            return $this->success('persist', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('DangerousGoodsValidator.persist.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.Cargo.DangerousGoodsValidator.persist.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('DangerousGoodsValidator.invalidate.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.Cargo.DangerousGoodsValidator.invalidate.success');

            return $this->success('invalidate', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('DangerousGoodsValidator.invalidate.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.Cargo.DangerousGoodsValidator.invalidate.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('DangerousGoodsValidator.broadcast.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.Cargo.DangerousGoodsValidator.broadcast.success');

            return $this->success('broadcast', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('DangerousGoodsValidator.broadcast.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.Cargo.DangerousGoodsValidator.broadcast.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('DangerousGoodsValidator.compact.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.Cargo.DangerousGoodsValidator.compact.success');

            return $this->success('compact', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('DangerousGoodsValidator.compact.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.Cargo.DangerousGoodsValidator.compact.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('DangerousGoodsValidator.archiveBatch.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.Cargo.DangerousGoodsValidator.archiveBatch.success');

            return $this->success('archiveBatch', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('DangerousGoodsValidator.archiveBatch.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.Cargo.DangerousGoodsValidator.archiveBatch.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('DangerousGoodsValidator.evaluateRules.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.Cargo.DangerousGoodsValidator.evaluateRules.success');

            return $this->success('evaluateRules', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('DangerousGoodsValidator.evaluateRules.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.Cargo.DangerousGoodsValidator.evaluateRules.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('DangerousGoodsValidator.applyPolicy.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.Cargo.DangerousGoodsValidator.applyPolicy.success');

            return $this->success('applyPolicy', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('DangerousGoodsValidator.applyPolicy.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.Cargo.DangerousGoodsValidator.applyPolicy.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('DangerousGoodsValidator.computeMetrics.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.Cargo.DangerousGoodsValidator.computeMetrics.success');

            return $this->success('computeMetrics', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('DangerousGoodsValidator.computeMetrics.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.Cargo.DangerousGoodsValidator.computeMetrics.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('DangerousGoodsValidator.buildPayload.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.Cargo.DangerousGoodsValidator.buildPayload.success');

            return $this->success('buildPayload', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('DangerousGoodsValidator.buildPayload.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.Cargo.DangerousGoodsValidator.buildPayload.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('DangerousGoodsValidator.transformInput.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.Cargo.DangerousGoodsValidator.transformInput.success');

            return $this->success('transformInput', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('DangerousGoodsValidator.transformInput.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.Cargo.DangerousGoodsValidator.transformInput.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('DangerousGoodsValidator.transformOutput.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.Cargo.DangerousGoodsValidator.transformOutput.success');

            return $this->success('transformOutput', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('DangerousGoodsValidator.transformOutput.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.Cargo.DangerousGoodsValidator.transformOutput.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('DangerousGoodsValidator.checkPreconditions.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.Cargo.DangerousGoodsValidator.checkPreconditions.success');

            return $this->success('checkPreconditions', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('DangerousGoodsValidator.checkPreconditions.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.Cargo.DangerousGoodsValidator.checkPreconditions.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('DangerousGoodsValidator.checkPostconditions.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.Cargo.DangerousGoodsValidator.checkPostconditions.success');

            return $this->success('checkPostconditions', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('DangerousGoodsValidator.checkPostconditions.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.Cargo.DangerousGoodsValidator.checkPostconditions.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('DangerousGoodsValidator.reserveResources.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.Cargo.DangerousGoodsValidator.reserveResources.success');

            return $this->success('reserveResources', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('DangerousGoodsValidator.reserveResources.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.Cargo.DangerousGoodsValidator.reserveResources.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('DangerousGoodsValidator.releaseResources.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.Cargo.DangerousGoodsValidator.releaseResources.success');

            return $this->success('releaseResources', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('DangerousGoodsValidator.releaseResources.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.Cargo.DangerousGoodsValidator.releaseResources.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('DangerousGoodsValidator.lockEntity.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.Cargo.DangerousGoodsValidator.lockEntity.success');

            return $this->success('lockEntity', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('DangerousGoodsValidator.lockEntity.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.Cargo.DangerousGoodsValidator.lockEntity.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('DangerousGoodsValidator.unlockEntity.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.Cargo.DangerousGoodsValidator.unlockEntity.success');

            return $this->success('unlockEntity', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('DangerousGoodsValidator.unlockEntity.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.Cargo.DangerousGoodsValidator.unlockEntity.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('DangerousGoodsValidator.queueFollowUp.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.Cargo.DangerousGoodsValidator.queueFollowUp.success');

            return $this->success('queueFollowUp', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('DangerousGoodsValidator.queueFollowUp.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.Cargo.DangerousGoodsValidator.queueFollowUp.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('DangerousGoodsValidator.scheduleRetry.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.Cargo.DangerousGoodsValidator.scheduleRetry.success');

            return $this->success('scheduleRetry', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('DangerousGoodsValidator.scheduleRetry.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.Cargo.DangerousGoodsValidator.scheduleRetry.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('DangerousGoodsValidator.markComplete.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.Cargo.DangerousGoodsValidator.markComplete.success');

            return $this->success('markComplete', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('DangerousGoodsValidator.markComplete.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.Cargo.DangerousGoodsValidator.markComplete.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('DangerousGoodsValidator.markFailed.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.Cargo.DangerousGoodsValidator.markFailed.success');

            return $this->success('markFailed', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('DangerousGoodsValidator.markFailed.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.Cargo.DangerousGoodsValidator.markFailed.failure');
    ...
    {
        $cacheKey = sprintf('domain:Cargo:DangerousGoodsValidator:%s:%s', $verb, md5(json_encode($context['payload'])));
    ...
    protected function compute(string $verb, array $context): array
    {
        ...
        return [
            'service' => 'DangerousGoodsValidator',
            'module' => 'Cargo',
            'verb' => $verb,
    ...
    protected function buildRecommendations(string $verb, float $score, array $payload): array
    {
        $recs = [];
        if ($score > 100) {
            $recs[] = ['code' => 'HIGH_LOAD', 'message' => 'High operational load detected for DangerousGoodsValidator'];
        }
    ...
    protected function afterHook(string $verb, array $context, array $result): void
    {
        if (in_array($verb, ['publish', 'broadcast', 'escalate'], true)) {
            $this->logger->info('DangerousGoodsValidator.after.'.$verb, [
                'correlation_id' => $context['correlation_id'],
