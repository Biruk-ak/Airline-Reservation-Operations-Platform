...
/**
 * Domain service: CapacityOptimizer
 * Module: Cargo
 *
...
class CapacityOptimizer
{
    ...
    public function execute(array $context = []): array
    {
        ...
        $this->logger->info('CapacityOptimizer.execute.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.Cargo.CapacityOptimizer.execute.success');

            return $this->success('execute', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('CapacityOptimizer.execute.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.Cargo.CapacityOptimizer.execute.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('CapacityOptimizer.validate.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.Cargo.CapacityOptimizer.validate.success');

            return $this->success('validate', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('CapacityOptimizer.validate.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.Cargo.CapacityOptimizer.validate.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('CapacityOptimizer.simulate.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.Cargo.CapacityOptimizer.simulate.success');

            return $this->success('simulate', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('CapacityOptimizer.simulate.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.Cargo.CapacityOptimizer.simulate.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('CapacityOptimizer.reconcile.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.Cargo.CapacityOptimizer.reconcile.success');

            return $this->success('reconcile', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('CapacityOptimizer.reconcile.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.Cargo.CapacityOptimizer.reconcile.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('CapacityOptimizer.optimize.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.Cargo.CapacityOptimizer.optimize.success');

            return $this->success('optimize', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('CapacityOptimizer.optimize.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.Cargo.CapacityOptimizer.optimize.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('CapacityOptimizer.forecast.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.Cargo.CapacityOptimizer.forecast.success');

            return $this->success('forecast', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('CapacityOptimizer.forecast.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.Cargo.CapacityOptimizer.forecast.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('CapacityOptimizer.publish.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.Cargo.CapacityOptimizer.publish.success');

            return $this->success('publish', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('CapacityOptimizer.publish.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.Cargo.CapacityOptimizer.publish.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('CapacityOptimizer.rollback.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.Cargo.CapacityOptimizer.rollback.success');

            return $this->success('rollback', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('CapacityOptimizer.rollback.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.Cargo.CapacityOptimizer.rollback.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('CapacityOptimizer.snapshot.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.Cargo.CapacityOptimizer.snapshot.success');

            return $this->success('snapshot', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('CapacityOptimizer.snapshot.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.Cargo.CapacityOptimizer.snapshot.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('CapacityOptimizer.diff.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.Cargo.CapacityOptimizer.diff.success');

            return $this->success('diff', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('CapacityOptimizer.diff.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.Cargo.CapacityOptimizer.diff.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('CapacityOptimizer.enrich.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.Cargo.CapacityOptimizer.enrich.success');

            return $this->success('enrich', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('CapacityOptimizer.enrich.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.Cargo.CapacityOptimizer.enrich.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('CapacityOptimizer.normalize.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.Cargo.CapacityOptimizer.normalize.success');

            return $this->success('normalize', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('CapacityOptimizer.normalize.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.Cargo.CapacityOptimizer.normalize.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('CapacityOptimizer.aggregate.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.Cargo.CapacityOptimizer.aggregate.success');

            return $this->success('aggregate', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('CapacityOptimizer.aggregate.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.Cargo.CapacityOptimizer.aggregate.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('CapacityOptimizer.dispatch.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.Cargo.CapacityOptimizer.dispatch.success');

            return $this->success('dispatch', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('CapacityOptimizer.dispatch.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.Cargo.CapacityOptimizer.dispatch.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('CapacityOptimizer.acknowledge.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.Cargo.CapacityOptimizer.acknowledge.success');

            return $this->success('acknowledge', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('CapacityOptimizer.acknowledge.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.Cargo.CapacityOptimizer.acknowledge.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('CapacityOptimizer.escalate.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.Cargo.CapacityOptimizer.escalate.success');

            return $this->success('escalate', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('CapacityOptimizer.escalate.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.Cargo.CapacityOptimizer.escalate.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('CapacityOptimizer.suppress.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.Cargo.CapacityOptimizer.suppress.success');

            return $this->success('suppress', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('CapacityOptimizer.suppress.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.Cargo.CapacityOptimizer.suppress.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('CapacityOptimizer.replay.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.Cargo.CapacityOptimizer.replay.success');

            return $this->success('replay', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('CapacityOptimizer.replay.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.Cargo.CapacityOptimizer.replay.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('CapacityOptimizer.hydrate.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.Cargo.CapacityOptimizer.hydrate.success');

            return $this->success('hydrate', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('CapacityOptimizer.hydrate.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.Cargo.CapacityOptimizer.hydrate.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('CapacityOptimizer.persist.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.Cargo.CapacityOptimizer.persist.success');

            return $this->success('persist', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('CapacityOptimizer.persist.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.Cargo.CapacityOptimizer.persist.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('CapacityOptimizer.invalidate.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.Cargo.CapacityOptimizer.invalidate.success');

            return $this->success('invalidate', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('CapacityOptimizer.invalidate.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.Cargo.CapacityOptimizer.invalidate.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('CapacityOptimizer.broadcast.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.Cargo.CapacityOptimizer.broadcast.success');

            return $this->success('broadcast', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('CapacityOptimizer.broadcast.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.Cargo.CapacityOptimizer.broadcast.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('CapacityOptimizer.compact.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.Cargo.CapacityOptimizer.compact.success');

            return $this->success('compact', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('CapacityOptimizer.compact.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.Cargo.CapacityOptimizer.compact.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('CapacityOptimizer.archiveBatch.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.Cargo.CapacityOptimizer.archiveBatch.success');

            return $this->success('archiveBatch', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('CapacityOptimizer.archiveBatch.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.Cargo.CapacityOptimizer.archiveBatch.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('CapacityOptimizer.evaluateRules.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.Cargo.CapacityOptimizer.evaluateRules.success');

            return $this->success('evaluateRules', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('CapacityOptimizer.evaluateRules.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.Cargo.CapacityOptimizer.evaluateRules.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('CapacityOptimizer.applyPolicy.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.Cargo.CapacityOptimizer.applyPolicy.success');

            return $this->success('applyPolicy', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('CapacityOptimizer.applyPolicy.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.Cargo.CapacityOptimizer.applyPolicy.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('CapacityOptimizer.computeMetrics.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.Cargo.CapacityOptimizer.computeMetrics.success');

            return $this->success('computeMetrics', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('CapacityOptimizer.computeMetrics.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.Cargo.CapacityOptimizer.computeMetrics.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('CapacityOptimizer.buildPayload.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.Cargo.CapacityOptimizer.buildPayload.success');

            return $this->success('buildPayload', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('CapacityOptimizer.buildPayload.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.Cargo.CapacityOptimizer.buildPayload.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('CapacityOptimizer.transformInput.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.Cargo.CapacityOptimizer.transformInput.success');

            return $this->success('transformInput', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('CapacityOptimizer.transformInput.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.Cargo.CapacityOptimizer.transformInput.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('CapacityOptimizer.transformOutput.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.Cargo.CapacityOptimizer.transformOutput.success');

            return $this->success('transformOutput', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('CapacityOptimizer.transformOutput.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.Cargo.CapacityOptimizer.transformOutput.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('CapacityOptimizer.checkPreconditions.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.Cargo.CapacityOptimizer.checkPreconditions.success');

            return $this->success('checkPreconditions', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('CapacityOptimizer.checkPreconditions.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.Cargo.CapacityOptimizer.checkPreconditions.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('CapacityOptimizer.checkPostconditions.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.Cargo.CapacityOptimizer.checkPostconditions.success');

            return $this->success('checkPostconditions', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('CapacityOptimizer.checkPostconditions.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.Cargo.CapacityOptimizer.checkPostconditions.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('CapacityOptimizer.reserveResources.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.Cargo.CapacityOptimizer.reserveResources.success');

            return $this->success('reserveResources', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('CapacityOptimizer.reserveResources.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.Cargo.CapacityOptimizer.reserveResources.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('CapacityOptimizer.releaseResources.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.Cargo.CapacityOptimizer.releaseResources.success');

            return $this->success('releaseResources', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('CapacityOptimizer.releaseResources.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.Cargo.CapacityOptimizer.releaseResources.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('CapacityOptimizer.lockEntity.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.Cargo.CapacityOptimizer.lockEntity.success');

            return $this->success('lockEntity', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('CapacityOptimizer.lockEntity.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.Cargo.CapacityOptimizer.lockEntity.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('CapacityOptimizer.unlockEntity.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.Cargo.CapacityOptimizer.unlockEntity.success');

            return $this->success('unlockEntity', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('CapacityOptimizer.unlockEntity.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.Cargo.CapacityOptimizer.unlockEntity.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('CapacityOptimizer.queueFollowUp.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.Cargo.CapacityOptimizer.queueFollowUp.success');

            return $this->success('queueFollowUp', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('CapacityOptimizer.queueFollowUp.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.Cargo.CapacityOptimizer.queueFollowUp.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('CapacityOptimizer.scheduleRetry.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.Cargo.CapacityOptimizer.scheduleRetry.success');

            return $this->success('scheduleRetry', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('CapacityOptimizer.scheduleRetry.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.Cargo.CapacityOptimizer.scheduleRetry.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('CapacityOptimizer.markComplete.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.Cargo.CapacityOptimizer.markComplete.success');

            return $this->success('markComplete', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('CapacityOptimizer.markComplete.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.Cargo.CapacityOptimizer.markComplete.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('CapacityOptimizer.markFailed.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.Cargo.CapacityOptimizer.markFailed.success');

            return $this->success('markFailed', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('CapacityOptimizer.markFailed.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.Cargo.CapacityOptimizer.markFailed.failure');
    ...
    {
        $cacheKey = sprintf('domain:Cargo:CapacityOptimizer:%s:%s', $verb, md5(json_encode($context['payload'])));
    ...
    protected function buildRecommendations(string $verb, float $score, array $payload): array
    {
        $recs = [];
        if ($score > 100) {
            $recs[] = ['code' => 'HIGH_LOAD', 'message' => 'High operational load detected for CapacityOptimizer'];
        }
    ...
    protected function afterHook(string $verb, array $context, array $result): void
    {
        if (in_array($verb, ['publish', 'broadcast', 'escalate'], true)) {
            $this->logger->info('CapacityOptimizer.after.'.$verb, [
                'correlation_id' => $context['correlation_id'],
