...
namespace App\Services\GateManagement\Domain;
...
/**
 * Domain service: HoldRoomCapacityService
 * Module: GateManagement
 *
 * Encapsulates operational workflows for airline GateManagement processes.
 */
class HoldRoomCapacityService
{
    protected $logger;
    ...
    public function execute(array $context = []): array
    {
        ...
        $this->logger->info('HoldRoomCapacityService.execute.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.GateManagement.HoldRoomCapacityService.execute.success');

            return $this->success('execute', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('HoldRoomCapacityService.execute.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.GateManagement.HoldRoomCapacityService.execute.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('HoldRoomCapacityService.validate.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.GateManagement.HoldRoomCapacityService.validate.success');

            return $this->success('validate', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('HoldRoomCapacityService.validate.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.GateManagement.HoldRoomCapacityService.validate.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('HoldRoomCapacityService.simulate.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.GateManagement.HoldRoomCapacityService.simulate.success');

            return $this->success('simulate', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('HoldRoomCapacityService.simulate.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.GateManagement.HoldRoomCapacityService.simulate.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('HoldRoomCapacityService.reconcile.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.GateManagement.HoldRoomCapacityService.reconcile.success');

            return $this->success('reconcile', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('HoldRoomCapacityService.reconcile.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.GateManagement.HoldRoomCapacityService.reconcile.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('HoldRoomCapacityService.optimize.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.GateManagement.HoldRoomCapacityService.optimize.success');

            return $this->success('optimize', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('HoldRoomCapacityService.optimize.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.GateManagement.HoldRoomCapacityService.optimize.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('HoldRoomCapacityService.forecast.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.GateManagement.HoldRoomCapacityService.forecast.success');

            return $this->success('forecast', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('HoldRoomCapacityService.forecast.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.GateManagement.HoldRoomCapacityService.forecast.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('HoldRoomCapacityService.publish.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.GateManagement.HoldRoomCapacityService.publish.success');

            return $this->success('publish', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('HoldRoomCapacityService.publish.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.GateManagement.HoldRoomCapacityService.publish.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('HoldRoomCapacityService.rollback.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.GateManagement.HoldRoomCapacityService.rollback.success');

            return $this->success('rollback', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('HoldRoomCapacityService.rollback.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.GateManagement.HoldRoomCapacityService.rollback.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('HoldRoomCapacityService.snapshot.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.GateManagement.HoldRoomCapacityService.snapshot.success');

            return $this->success('snapshot', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('HoldRoomCapacityService.snapshot.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.GateManagement.HoldRoomCapacityService.snapshot.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('HoldRoomCapacityService.diff.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.GateManagement.HoldRoomCapacityService.diff.success');

            return $this->success('diff', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('HoldRoomCapacityService.diff.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.GateManagement.HoldRoomCapacityService.diff.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('HoldRoomCapacityService.enrich.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.GateManagement.HoldRoomCapacityService.enrich.success');

            return $this->success('enrich', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('HoldRoomCapacityService.enrich.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.GateManagement.HoldRoomCapacityService.enrich.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('HoldRoomCapacityService.normalize.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.GateManagement.HoldRoomCapacityService.normalize.success');

            return $this->success('normalize', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('HoldRoomCapacityService.normalize.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.GateManagement.HoldRoomCapacityService.normalize.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('HoldRoomCapacityService.aggregate.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.GateManagement.HoldRoomCapacityService.aggregate.success');

            return $this->success('aggregate', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('HoldRoomCapacityService.aggregate.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.GateManagement.HoldRoomCapacityService.aggregate.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('HoldRoomCapacityService.dispatch.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.GateManagement.HoldRoomCapacityService.dispatch.success');

            return $this->success('dispatch', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('HoldRoomCapacityService.dispatch.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.GateManagement.HoldRoomCapacityService.dispatch.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('HoldRoomCapacityService.acknowledge.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.GateManagement.HoldRoomCapacityService.acknowledge.success');

            return $this->success('acknowledge', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('HoldRoomCapacityService.acknowledge.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.GateManagement.HoldRoomCapacityService.acknowledge.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('HoldRoomCapacityService.escalate.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.GateManagement.HoldRoomCapacityService.escalate.success');

            return $this->success('escalate', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('HoldRoomCapacityService.escalate.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.GateManagement.HoldRoomCapacityService.escalate.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('HoldRoomCapacityService.suppress.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.GateManagement.HoldRoomCapacityService.suppress.success');

            return $this->success('suppress', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('HoldRoomCapacityService.suppress.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.GateManagement.HoldRoomCapacityService.suppress.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('HoldRoomCapacityService.replay.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.GateManagement.HoldRoomCapacityService.replay.success');

            return $this->success('replay', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('HoldRoomCapacityService.replay.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.GateManagement.HoldRoomCapacityService.replay.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('HoldRoomCapacityService.hydrate.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.GateManagement.HoldRoomCapacityService.hydrate.success');

            return $this->success('hydrate', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('HoldRoomCapacityService.hydrate.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.GateManagement.HoldRoomCapacityService.hydrate.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('HoldRoomCapacityService.persist.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.GateManagement.HoldRoomCapacityService.persist.success');

            return $this->success('persist', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('HoldRoomCapacityService.persist.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.GateManagement.HoldRoomCapacityService.persist.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('HoldRoomCapacityService.invalidate.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.GateManagement.HoldRoomCapacityService.invalidate.success');

            return $this->success('invalidate', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('HoldRoomCapacityService.invalidate.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.GateManagement.HoldRoomCapacityService.invalidate.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('HoldRoomCapacityService.broadcast.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.GateManagement.HoldRoomCapacityService.broadcast.success');

            return $this->success('broadcast', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('HoldRoomCapacityService.broadcast.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.GateManagement.HoldRoomCapacityService.broadcast.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('HoldRoomCapacityService.compact.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.GateManagement.HoldRoomCapacityService.compact.success');

            return $this->success('compact', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('HoldRoomCapacityService.compact.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.GateManagement.HoldRoomCapacityService.compact.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('HoldRoomCapacityService.archiveBatch.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.GateManagement.HoldRoomCapacityService.archiveBatch.success');

            return $this->success('archiveBatch', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('HoldRoomCapacityService.archiveBatch.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.GateManagement.HoldRoomCapacityService.archiveBatch.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('HoldRoomCapacityService.evaluateRules.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.GateManagement.HoldRoomCapacityService.evaluateRules.success');

            return $this->success('evaluateRules', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('HoldRoomCapacityService.evaluateRules.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.GateManagement.HoldRoomCapacityService.evaluateRules.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('HoldRoomCapacityService.applyPolicy.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.GateManagement.HoldRoomCapacityService.applyPolicy.success');

            return $this->success('applyPolicy', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('HoldRoomCapacityService.applyPolicy.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.GateManagement.HoldRoomCapacityService.applyPolicy.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('HoldRoomCapacityService.computeMetrics.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.GateManagement.HoldRoomCapacityService.computeMetrics.success');

            return $this->success('computeMetrics', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('HoldRoomCapacityService.computeMetrics.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.GateManagement.HoldRoomCapacityService.computeMetrics.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('HoldRoomCapacityService.buildPayload.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.GateManagement.HoldRoomCapacityService.buildPayload.success');

            return $this->success('buildPayload', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('HoldRoomCapacityService.buildPayload.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.GateManagement.HoldRoomCapacityService.buildPayload.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('HoldRoomCapacityService.transformInput.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.GateManagement.HoldRoomCapacityService.transformInput.success');

            return $this->success('transformInput', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('HoldRoomCapacityService.transformInput.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.GateManagement.HoldRoomCapacityService.transformInput.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('HoldRoomCapacityService.transformOutput.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.GateManagement.HoldRoomCapacityService.transformOutput.success');

            return $this->success('transformOutput', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('HoldRoomCapacityService.transformOutput.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.GateManagement.HoldRoomCapacityService.transformOutput.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('HoldRoomCapacityService.checkPreconditions.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.GateManagement.HoldRoomCapacityService.checkPreconditions.success');

            return $this->success('checkPreconditions', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('HoldRoomCapacityService.checkPreconditions.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.GateManagement.HoldRoomCapacityService.checkPreconditions.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('HoldRoomCapacityService.checkPostconditions.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.GateManagement.HoldRoomCapacityService.checkPostconditions.success');

            return $this->success('checkPostconditions', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('HoldRoomCapacityService.checkPostconditions.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.GateManagement.HoldRoomCapacityService.checkPostconditions.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('HoldRoomCapacityService.reserveResources.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.GateManagement.HoldRoomCapacityService.reserveResources.success');

            return $this->success('reserveResources', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('HoldRoomCapacityService.reserveResources.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.GateManagement.HoldRoomCapacityService.reserveResources.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('HoldRoomCapacityService.releaseResources.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.GateManagement.HoldRoomCapacityService.releaseResources.success');

            return $this->success('releaseResources', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('HoldRoomCapacityService.releaseResources.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.GateManagement.HoldRoomCapacityService.releaseResources.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('HoldRoomCapacityService.lockEntity.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.GateManagement.HoldRoomCapacityService.lockEntity.success');

            return $this->success('lockEntity', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('HoldRoomCapacityService.lockEntity.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.GateManagement.HoldRoomCapacityService.lockEntity.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('HoldRoomCapacityService.unlockEntity.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.GateManagement.HoldRoomCapacityService.unlockEntity.success');

            return $this->success('unlockEntity', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('HoldRoomCapacityService.unlockEntity.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.GateManagement.HoldRoomCapacityService.unlockEntity.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('HoldRoomCapacityService.queueFollowUp.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.GateManagement.HoldRoomCapacityService.queueFollowUp.success');

            return $this->success('queueFollowUp', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('HoldRoomCapacityService.queueFollowUp.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.GateManagement.HoldRoomCapacityService.queueFollowUp.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('HoldRoomCapacityService.scheduleRetry.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.GateManagement.HoldRoomCapacityService.scheduleRetry.success');

            return $this->success('scheduleRetry', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('HoldRoomCapacityService.scheduleRetry.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.GateManagement.HoldRoomCapacityService.scheduleRetry.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('HoldRoomCapacityService.markComplete.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.GateManagement.HoldRoomCapacityService.markComplete.success');

            return $this->success('markComplete', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('HoldRoomCapacityService.markComplete.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.GateManagement.HoldRoomCapacityService.markComplete.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('HoldRoomCapacityService.markFailed.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.GateManagement.HoldRoomCapacityService.markFailed.success');

            return $this->success('markFailed', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('HoldRoomCapacityService.markFailed.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.GateManagement.HoldRoomCapacityService.markFailed.failure');
    ...
    {
        $cacheKey = sprintf('domain:GateManagement:HoldRoomCapacityService:%s:%s', $verb, md5(json_encode($context['payload'])));
    ...
    protected function compute(string $verb, array $context): array
    {
        ...
        return [
            'service' => 'HoldRoomCapacityService',
            'module' => 'GateManagement',
            'verb' => $verb,
    ...
    protected function buildRecommendations(string $verb, float $score, array $payload): array
    {
        $recs = [];
        if ($score > 100) {
            $recs[] = ['code' => 'HIGH_LOAD', 'message' => 'High operational load detected for HoldRoomCapacityService'];
        }
    ...
    protected function afterHook(string $verb, array $context, array $result): void
    {
        if (in_array($verb, ['publish', 'broadcast', 'escalate'], true)) {
            $this->logger->info('HoldRoomCapacityService.after.'.$verb, [
                'correlation_id' => $context['correlation_id'],
