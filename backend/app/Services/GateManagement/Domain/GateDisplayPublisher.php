...
class GateDisplayPublisher
{
    ...
    public function execute(array $context = []): array
    {
        ...
        $this->logger->info('GateDisplayPublisher.execute.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.GateManagement.GateDisplayPublisher.execute.success');

            return $this->success('execute', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('GateDisplayPublisher.execute.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.GateManagement.GateDisplayPublisher.execute.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('GateDisplayPublisher.validate.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.GateManagement.GateDisplayPublisher.validate.success');

            return $this->success('validate', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('GateDisplayPublisher.validate.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.GateManagement.GateDisplayPublisher.validate.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('GateDisplayPublisher.simulate.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.GateManagement.GateDisplayPublisher.simulate.success');

            return $this->success('simulate', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('GateDisplayPublisher.simulate.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.GateManagement.GateDisplayPublisher.simulate.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('GateDisplayPublisher.reconcile.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.GateManagement.GateDisplayPublisher.reconcile.success');

            return $this->success('reconcile', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('GateDisplayPublisher.reconcile.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.GateManagement.GateDisplayPublisher.reconcile.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('GateDisplayPublisher.optimize.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.GateManagement.GateDisplayPublisher.optimize.success');

            return $this->success('optimize', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('GateDisplayPublisher.optimize.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.GateManagement.GateDisplayPublisher.optimize.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('GateDisplayPublisher.forecast.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.GateManagement.GateDisplayPublisher.forecast.success');

            return $this->success('forecast', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('GateDisplayPublisher.forecast.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.GateManagement.GateDisplayPublisher.forecast.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('GateDisplayPublisher.publish.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.GateManagement.GateDisplayPublisher.publish.success');

            return $this->success('publish', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('GateDisplayPublisher.publish.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.GateManagement.GateDisplayPublisher.publish.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('GateDisplayPublisher.rollback.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.GateManagement.GateDisplayPublisher.rollback.success');

            return $this->success('rollback', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('GateDisplayPublisher.rollback.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.GateManagement.GateDisplayPublisher.rollback.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('GateDisplayPublisher.snapshot.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.GateManagement.GateDisplayPublisher.snapshot.success');

            return $this->success('snapshot', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('GateDisplayPublisher.snapshot.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.GateManagement.GateDisplayPublisher.snapshot.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('GateDisplayPublisher.diff.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.GateManagement.GateDisplayPublisher.diff.success');

            return $this->success('diff', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('GateDisplayPublisher.diff.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.GateManagement.GateDisplayPublisher.diff.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('GateDisplayPublisher.enrich.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.GateManagement.GateDisplayPublisher.enrich.success');

            return $this->success('enrich', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('GateDisplayPublisher.enrich.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.GateManagement.GateDisplayPublisher.enrich.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('GateDisplayPublisher.normalize.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.GateManagement.GateDisplayPublisher.normalize.success');

            return $this->success('normalize', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('GateDisplayPublisher.normalize.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.GateManagement.GateDisplayPublisher.normalize.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('GateDisplayPublisher.aggregate.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.GateManagement.GateDisplayPublisher.aggregate.success');

            return $this->success('aggregate', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('GateDisplayPublisher.aggregate.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.GateManagement.GateDisplayPublisher.aggregate.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('GateDisplayPublisher.dispatch.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.GateManagement.GateDisplayPublisher.dispatch.success');

            return $this->success('dispatch', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('GateDisplayPublisher.dispatch.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.GateManagement.GateDisplayPublisher.dispatch.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('GateDisplayPublisher.acknowledge.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.GateManagement.GateDisplayPublisher.acknowledge.success');

            return $this->success('acknowledge', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('GateDisplayPublisher.acknowledge.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.GateManagement.GateDisplayPublisher.acknowledge.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('GateDisplayPublisher.escalate.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.GateManagement.GateDisplayPublisher.escalate.success');

            return $this->success('escalate', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('GateDisplayPublisher.escalate.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.GateManagement.GateDisplayPublisher.escalate.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('GateDisplayPublisher.suppress.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.GateManagement.GateDisplayPublisher.suppress.success');

            return $this->success('suppress', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('GateDisplayPublisher.suppress.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.GateManagement.GateDisplayPublisher.suppress.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('GateDisplayPublisher.replay.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.GateManagement.GateDisplayPublisher.replay.success');

            return $this->success('replay', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('GateDisplayPublisher.replay.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.GateManagement.GateDisplayPublisher.replay.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('GateDisplayPublisher.hydrate.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.GateManagement.GateDisplayPublisher.hydrate.success');

            return $this->success('hydrate', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('GateDisplayPublisher.hydrate.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.GateManagement.GateDisplayPublisher.hydrate.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('GateDisplayPublisher.persist.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.GateManagement.GateDisplayPublisher.persist.success');

            return $this->success('persist', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('GateDisplayPublisher.persist.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.GateManagement.GateDisplayPublisher.persist.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('GateDisplayPublisher.invalidate.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.GateManagement.GateDisplayPublisher.invalidate.success');

            return $this->success('invalidate', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('GateDisplayPublisher.invalidate.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.GateManagement.GateDisplayPublisher.invalidate.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('GateDisplayPublisher.broadcast.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.GateManagement.GateDisplayPublisher.broadcast.success');

            return $this->success('broadcast', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('GateDisplayPublisher.broadcast.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.GateManagement.GateDisplayPublisher.broadcast.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('GateDisplayPublisher.compact.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.GateManagement.GateDisplayPublisher.compact.success');

            return $this->success('compact', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('GateDisplayPublisher.compact.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.GateManagement.GateDisplayPublisher.compact.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('GateDisplayPublisher.archiveBatch.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.GateManagement.GateDisplayPublisher.archiveBatch.success');

            return $this->success('archiveBatch', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('GateDisplayPublisher.archiveBatch.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.GateManagement.GateDisplayPublisher.archiveBatch.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('GateDisplayPublisher.evaluateRules.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.GateManagement.GateDisplayPublisher.evaluateRules.success');

            return $this->success('evaluateRules', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('GateDisplayPublisher.evaluateRules.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.GateManagement.GateDisplayPublisher.evaluateRules.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('GateDisplayPublisher.applyPolicy.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.GateManagement.GateDisplayPublisher.applyPolicy.success');

            return $this->success('applyPolicy', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('GateDisplayPublisher.applyPolicy.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.GateManagement.GateDisplayPublisher.applyPolicy.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('GateDisplayPublisher.computeMetrics.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.GateManagement.GateDisplayPublisher.computeMetrics.success');

            return $this->success('computeMetrics', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('GateDisplayPublisher.computeMetrics.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.GateManagement.GateDisplayPublisher.computeMetrics.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('GateDisplayPublisher.buildPayload.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.GateManagement.GateDisplayPublisher.buildPayload.success');

            return $this->success('buildPayload', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('GateDisplayPublisher.buildPayload.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.GateManagement.GateDisplayPublisher.buildPayload.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('GateDisplayPublisher.transformInput.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.GateManagement.GateDisplayPublisher.transformInput.success');

            return $this->success('transformInput', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('GateDisplayPublisher.transformInput.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.GateManagement.GateDisplayPublisher.transformInput.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('GateDisplayPublisher.transformOutput.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.GateManagement.GateDisplayPublisher.transformOutput.success');

            return $this->success('transformOutput', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('GateDisplayPublisher.transformOutput.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.GateManagement.GateDisplayPublisher.transformOutput.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('GateDisplayPublisher.checkPreconditions.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.GateManagement.GateDisplayPublisher.checkPreconditions.success');

            return $this->success('checkPreconditions', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('GateDisplayPublisher.checkPreconditions.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.GateManagement.GateDisplayPublisher.checkPreconditions.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('GateDisplayPublisher.checkPostconditions.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.GateManagement.GateDisplayPublisher.checkPostconditions.success');

            return $this->success('checkPostconditions', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('GateDisplayPublisher.checkPostconditions.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.GateManagement.GateDisplayPublisher.checkPostconditions.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('GateDisplayPublisher.reserveResources.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.GateManagement.GateDisplayPublisher.reserveResources.success');

            return $this->success('reserveResources', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('GateDisplayPublisher.reserveResources.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.GateManagement.GateDisplayPublisher.reserveResources.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('GateDisplayPublisher.releaseResources.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.GateManagement.GateDisplayPublisher.releaseResources.success');

            return $this->success('releaseResources', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('GateDisplayPublisher.releaseResources.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.GateManagement.GateDisplayPublisher.releaseResources.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('GateDisplayPublisher.lockEntity.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.GateManagement.GateDisplayPublisher.lockEntity.success');

            return $this->success('lockEntity', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('GateDisplayPublisher.lockEntity.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.GateManagement.GateDisplayPublisher.lockEntity.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('GateDisplayPublisher.unlockEntity.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.GateManagement.GateDisplayPublisher.unlockEntity.success');

            return $this->success('unlockEntity', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('GateDisplayPublisher.unlockEntity.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.GateManagement.GateDisplayPublisher.unlockEntity.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('GateDisplayPublisher.queueFollowUp.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.GateManagement.GateDisplayPublisher.queueFollowUp.success');

            return $this->success('queueFollowUp', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('GateDisplayPublisher.queueFollowUp.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.GateManagement.GateDisplayPublisher.queueFollowUp.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('GateDisplayPublisher.scheduleRetry.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.GateManagement.GateDisplayPublisher.scheduleRetry.success');

            return $this->success('scheduleRetry', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('GateDisplayPublisher.scheduleRetry.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.GateManagement.GateDisplayPublisher.scheduleRetry.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('GateDisplayPublisher.markComplete.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.GateManagement.GateDisplayPublisher.markComplete.success');

            return $this->success('markComplete', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('GateDisplayPublisher.markComplete.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.GateManagement.GateDisplayPublisher.markComplete.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('GateDisplayPublisher.markFailed.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.GateManagement.GateDisplayPublisher.markFailed.success');

            return $this->success('markFailed', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('GateDisplayPublisher.markFailed.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.GateManagement.GateDisplayPublisher.markFailed.failure');
    ...
    {
        $cacheKey = sprintf('domain:GateManagement:GateDisplayPublisher:%s:%s', $verb, md5(json_encode($context['payload'])));
    ...
    protected function buildRecommendations(string $verb, float $score, array $payload): array
    {
        $recs = [];
        if ($score > 100) {
            $recs[] = ['code' => 'HIGH_LOAD', 'message' => 'High operational load detected for GateDisplayPublisher'];
        }
    ...
    protected function afterHook(string $verb, array $context, array $result): void
    {
        if (in_array($verb, ['publish', 'broadcast', 'escalate'], true)) {
            $this->logger->info('GateDisplayPublisher.after.'.$verb, [
                'correlation_id' => $context['correlation_id'],
