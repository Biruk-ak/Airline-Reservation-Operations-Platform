...
/**
 * Domain service: WeatherImpactScorer
...
class WeatherImpactScorer
{
    ...
    public function execute(array $context = []): array
    {
        ...
        $this->logger->info('WeatherImpactScorer.execute.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.WeatherIntegration.WeatherImpactScorer.execute.success');

            return $this->success('execute', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('WeatherImpactScorer.execute.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.WeatherIntegration.WeatherImpactScorer.execute.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('WeatherImpactScorer.validate.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.WeatherIntegration.WeatherImpactScorer.validate.success');

            return $this->success('validate', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('WeatherImpactScorer.validate.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.WeatherIntegration.WeatherImpactScorer.validate.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('WeatherImpactScorer.simulate.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.WeatherIntegration.WeatherImpactScorer.simulate.success');

            return $this->success('simulate', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('WeatherImpactScorer.simulate.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.WeatherIntegration.WeatherImpactScorer.simulate.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('WeatherImpactScorer.reconcile.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.WeatherIntegration.WeatherImpactScorer.reconcile.success');

            return $this->success('reconcile', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('WeatherImpactScorer.reconcile.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.WeatherIntegration.WeatherImpactScorer.reconcile.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('WeatherImpactScorer.optimize.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.WeatherIntegration.WeatherImpactScorer.optimize.success');

            return $this->success('optimize', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('WeatherImpactScorer.optimize.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.WeatherIntegration.WeatherImpactScorer.optimize.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('WeatherImpactScorer.forecast.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.WeatherIntegration.WeatherImpactScorer.forecast.success');

            return $this->success('forecast', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('WeatherImpactScorer.forecast.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.WeatherIntegration.WeatherImpactScorer.forecast.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('WeatherImpactScorer.publish.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.WeatherIntegration.WeatherImpactScorer.publish.success');

            return $this->success('publish', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('WeatherImpactScorer.publish.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.WeatherIntegration.WeatherImpactScorer.publish.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('WeatherImpactScorer.rollback.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.WeatherIntegration.WeatherImpactScorer.rollback.success');

            return $this->success('rollback', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('WeatherImpactScorer.rollback.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.WeatherIntegration.WeatherImpactScorer.rollback.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('WeatherImpactScorer.snapshot.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.WeatherIntegration.WeatherImpactScorer.snapshot.success');

            return $this->success('snapshot', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('WeatherImpactScorer.snapshot.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.WeatherIntegration.WeatherImpactScorer.snapshot.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('WeatherImpactScorer.diff.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.WeatherIntegration.WeatherImpactScorer.diff.success');

            return $this->success('diff', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('WeatherImpactScorer.diff.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.WeatherIntegration.WeatherImpactScorer.diff.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('WeatherImpactScorer.enrich.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.WeatherIntegration.WeatherImpactScorer.enrich.success');

            return $this->success('enrich', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('WeatherImpactScorer.enrich.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.WeatherIntegration.WeatherImpactScorer.enrich.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('WeatherImpactScorer.normalize.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.WeatherIntegration.WeatherImpactScorer.normalize.success');

            return $this->success('normalize', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('WeatherImpactScorer.normalize.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.WeatherIntegration.WeatherImpactScorer.normalize.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('WeatherImpactScorer.aggregate.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.WeatherIntegration.WeatherImpactScorer.aggregate.success');

            return $this->success('aggregate', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('WeatherImpactScorer.aggregate.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.WeatherIntegration.WeatherImpactScorer.aggregate.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('WeatherImpactScorer.dispatch.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.WeatherIntegration.WeatherImpactScorer.dispatch.success');

            return $this->success('dispatch', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('WeatherImpactScorer.dispatch.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.WeatherIntegration.WeatherImpactScorer.dispatch.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('WeatherImpactScorer.acknowledge.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.WeatherIntegration.WeatherImpactScorer.acknowledge.success');

            return $this->success('acknowledge', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('WeatherImpactScorer.acknowledge.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.WeatherIntegration.WeatherImpactScorer.acknowledge.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('WeatherImpactScorer.escalate.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.WeatherIntegration.WeatherImpactScorer.escalate.success');

            return $this->success('escalate', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('WeatherImpactScorer.escalate.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.WeatherIntegration.WeatherImpactScorer.escalate.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('WeatherImpactScorer.suppress.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.WeatherIntegration.WeatherImpactScorer.suppress.success');

            return $this->success('suppress', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('WeatherImpactScorer.suppress.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.WeatherIntegration.WeatherImpactScorer.suppress.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('WeatherImpactScorer.replay.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.WeatherIntegration.WeatherImpactScorer.replay.success');

            return $this->success('replay', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('WeatherImpactScorer.replay.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.WeatherIntegration.WeatherImpactScorer.replay.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('WeatherImpactScorer.hydrate.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.WeatherIntegration.WeatherImpactScorer.hydrate.success');

            return $this->success('hydrate', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('WeatherImpactScorer.hydrate.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.WeatherIntegration.WeatherImpactScorer.hydrate.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('WeatherImpactScorer.persist.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.WeatherIntegration.WeatherImpactScorer.persist.success');

            return $this->success('persist', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('WeatherImpactScorer.persist.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.WeatherIntegration.WeatherImpactScorer.persist.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('WeatherImpactScorer.invalidate.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.WeatherIntegration.WeatherImpactScorer.invalidate.success');

            return $this->success('invalidate', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('WeatherImpactScorer.invalidate.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.WeatherIntegration.WeatherImpactScorer.invalidate.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('WeatherImpactScorer.broadcast.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.WeatherIntegration.WeatherImpactScorer.broadcast.success');

            return $this->success('broadcast', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('WeatherImpactScorer.broadcast.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.WeatherIntegration.WeatherImpactScorer.broadcast.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('WeatherImpactScorer.compact.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.WeatherIntegration.WeatherImpactScorer.compact.success');

            return $this->success('compact', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('WeatherImpactScorer.compact.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.WeatherIntegration.WeatherImpactScorer.compact.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('WeatherImpactScorer.archiveBatch.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.WeatherIntegration.WeatherImpactScorer.archiveBatch.success');

            return $this->success('archiveBatch', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('WeatherImpactScorer.archiveBatch.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.WeatherIntegration.WeatherImpactScorer.archiveBatch.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('WeatherImpactScorer.evaluateRules.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.WeatherIntegration.WeatherImpactScorer.evaluateRules.success');

            return $this->success('evaluateRules', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('WeatherImpactScorer.evaluateRules.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.WeatherIntegration.WeatherImpactScorer.evaluateRules.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('WeatherImpactScorer.applyPolicy.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.WeatherIntegration.WeatherImpactScorer.applyPolicy.success');

            return $this->success('applyPolicy', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('WeatherImpactScorer.applyPolicy.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.WeatherIntegration.WeatherImpactScorer.applyPolicy.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('WeatherImpactScorer.computeMetrics.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.WeatherIntegration.WeatherImpactScorer.computeMetrics.success');

            return $this->success('computeMetrics', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('WeatherImpactScorer.computeMetrics.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.WeatherIntegration.WeatherImpactScorer.computeMetrics.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('WeatherImpactScorer.buildPayload.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.WeatherIntegration.WeatherImpactScorer.buildPayload.success');

            return $this->success('buildPayload', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('WeatherImpactScorer.buildPayload.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.WeatherIntegration.WeatherImpactScorer.buildPayload.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('WeatherImpactScorer.transformInput.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.WeatherIntegration.WeatherImpactScorer.transformInput.success');

            return $this->success('transformInput', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('WeatherImpactScorer.transformInput.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.WeatherIntegration.WeatherImpactScorer.transformInput.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('WeatherImpactScorer.transformOutput.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.WeatherIntegration.WeatherImpactScorer.transformOutput.success');

            return $this->success('transformOutput', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('WeatherImpactScorer.transformOutput.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.WeatherIntegration.WeatherImpactScorer.transformOutput.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('WeatherImpactScorer.checkPreconditions.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.WeatherIntegration.WeatherImpactScorer.checkPreconditions.success');

            return $this->success('checkPreconditions', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('WeatherImpactScorer.checkPreconditions.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.WeatherIntegration.WeatherImpactScorer.checkPreconditions.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('WeatherImpactScorer.checkPostconditions.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.WeatherIntegration.WeatherImpactScorer.checkPostconditions.success');

            return $this->success('checkPostconditions', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('WeatherImpactScorer.checkPostconditions.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.WeatherIntegration.WeatherImpactScorer.checkPostconditions.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('WeatherImpactScorer.reserveResources.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.WeatherIntegration.WeatherImpactScorer.reserveResources.success');

            return $this->success('reserveResources', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('WeatherImpactScorer.reserveResources.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.WeatherIntegration.WeatherImpactScorer.reserveResources.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('WeatherImpactScorer.releaseResources.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.WeatherIntegration.WeatherImpactScorer.releaseResources.success');

            return $this->success('releaseResources', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('WeatherImpactScorer.releaseResources.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.WeatherIntegration.WeatherImpactScorer.releaseResources.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('WeatherImpactScorer.lockEntity.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.WeatherIntegration.WeatherImpactScorer.lockEntity.success');

            return $this->success('lockEntity', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('WeatherImpactScorer.lockEntity.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.WeatherIntegration.WeatherImpactScorer.lockEntity.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('WeatherImpactScorer.unlockEntity.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.WeatherIntegration.WeatherImpactScorer.unlockEntity.success');

            return $this->success('unlockEntity', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('WeatherImpactScorer.unlockEntity.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.WeatherIntegration.WeatherImpactScorer.unlockEntity.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('WeatherImpactScorer.queueFollowUp.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.WeatherIntegration.WeatherImpactScorer.queueFollowUp.success');

            return $this->success('queueFollowUp', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('WeatherImpactScorer.queueFollowUp.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.WeatherIntegration.WeatherImpactScorer.queueFollowUp.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('WeatherImpactScorer.scheduleRetry.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.WeatherIntegration.WeatherImpactScorer.scheduleRetry.success');

            return $this->success('scheduleRetry', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('WeatherImpactScorer.scheduleRetry.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.WeatherIntegration.WeatherImpactScorer.scheduleRetry.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('WeatherImpactScorer.markComplete.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.WeatherIntegration.WeatherImpactScorer.markComplete.success');

            return $this->success('markComplete', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('WeatherImpactScorer.markComplete.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.WeatherIntegration.WeatherImpactScorer.markComplete.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('WeatherImpactScorer.markFailed.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.WeatherIntegration.WeatherImpactScorer.markFailed.success');

            return $this->success('markFailed', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('WeatherImpactScorer.markFailed.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.WeatherIntegration.WeatherImpactScorer.markFailed.failure');
    ...
    {
        $cacheKey = sprintf('domain:WeatherIntegration:WeatherImpactScorer:%s:%s', $verb, md5(json_encode($context['payload'])));
    ...
    protected function buildRecommendations(string $verb, float $score, array $payload): array
    {
        $recs = [];
        if ($score > 100) {
            $recs[] = ['code' => 'HIGH_LOAD', 'message' => 'High operational load detected for WeatherImpactScorer'];
        }
    ...
    protected function afterHook(string $verb, array $context, array $result): void
    {
        if (in_array($verb, ['publish', 'broadcast', 'escalate'], true)) {
            $this->logger->info('WeatherImpactScorer.after.'.$verb, [
                'correlation_id' => $context['correlation_id'],
