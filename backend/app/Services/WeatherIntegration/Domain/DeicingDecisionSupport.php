...
class DeicingDecisionSupport
{
    ...
    public function execute(array $context = []): array
    {
        ...
        $this->logger->info('DeicingDecisionSupport.execute.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.WeatherIntegration.DeicingDecisionSupport.execute.success');

            return $this->success('execute', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('DeicingDecisionSupport.execute.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.WeatherIntegration.DeicingDecisionSupport.execute.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('DeicingDecisionSupport.validate.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.WeatherIntegration.DeicingDecisionSupport.validate.success');

            return $this->success('validate', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('DeicingDecisionSupport.validate.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.WeatherIntegration.DeicingDecisionSupport.validate.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('DeicingDecisionSupport.simulate.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.WeatherIntegration.DeicingDecisionSupport.simulate.success');

            return $this->success('simulate', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('DeicingDecisionSupport.simulate.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.WeatherIntegration.DeicingDecisionSupport.simulate.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('DeicingDecisionSupport.reconcile.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.WeatherIntegration.DeicingDecisionSupport.reconcile.success');

            return $this->success('reconcile', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('DeicingDecisionSupport.reconcile.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.WeatherIntegration.DeicingDecisionSupport.reconcile.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('DeicingDecisionSupport.optimize.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.WeatherIntegration.DeicingDecisionSupport.optimize.success');

            return $this->success('optimize', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('DeicingDecisionSupport.optimize.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.WeatherIntegration.DeicingDecisionSupport.optimize.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('DeicingDecisionSupport.forecast.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.WeatherIntegration.DeicingDecisionSupport.forecast.success');

            return $this->success('forecast', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('DeicingDecisionSupport.forecast.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.WeatherIntegration.DeicingDecisionSupport.forecast.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('DeicingDecisionSupport.publish.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.WeatherIntegration.DeicingDecisionSupport.publish.success');

            return $this->success('publish', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('DeicingDecisionSupport.publish.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.WeatherIntegration.DeicingDecisionSupport.publish.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('DeicingDecisionSupport.rollback.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.WeatherIntegration.DeicingDecisionSupport.rollback.success');

            return $this->success('rollback', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('DeicingDecisionSupport.rollback.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.WeatherIntegration.DeicingDecisionSupport.rollback.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('DeicingDecisionSupport.snapshot.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.WeatherIntegration.DeicingDecisionSupport.snapshot.success');

            return $this->success('snapshot', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('DeicingDecisionSupport.snapshot.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.WeatherIntegration.DeicingDecisionSupport.snapshot.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('DeicingDecisionSupport.diff.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.WeatherIntegration.DeicingDecisionSupport.diff.success');

            return $this->success('diff', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('DeicingDecisionSupport.diff.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.WeatherIntegration.DeicingDecisionSupport.diff.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('DeicingDecisionSupport.enrich.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.WeatherIntegration.DeicingDecisionSupport.enrich.success');

            return $this->success('enrich', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('DeicingDecisionSupport.enrich.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.WeatherIntegration.DeicingDecisionSupport.enrich.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('DeicingDecisionSupport.normalize.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.WeatherIntegration.DeicingDecisionSupport.normalize.success');

            return $this->success('normalize', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('DeicingDecisionSupport.normalize.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.WeatherIntegration.DeicingDecisionSupport.normalize.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('DeicingDecisionSupport.aggregate.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.WeatherIntegration.DeicingDecisionSupport.aggregate.success');

            return $this->success('aggregate', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('DeicingDecisionSupport.aggregate.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.WeatherIntegration.DeicingDecisionSupport.aggregate.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('DeicingDecisionSupport.dispatch.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.WeatherIntegration.DeicingDecisionSupport.dispatch.success');

            return $this->success('dispatch', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('DeicingDecisionSupport.dispatch.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.WeatherIntegration.DeicingDecisionSupport.dispatch.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('DeicingDecisionSupport.acknowledge.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.WeatherIntegration.DeicingDecisionSupport.acknowledge.success');

            return $this->success('acknowledge', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('DeicingDecisionSupport.acknowledge.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.WeatherIntegration.DeicingDecisionSupport.acknowledge.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('DeicingDecisionSupport.escalate.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.WeatherIntegration.DeicingDecisionSupport.escalate.success');

            return $this->success('escalate', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('DeicingDecisionSupport.escalate.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.WeatherIntegration.DeicingDecisionSupport.escalate.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('DeicingDecisionSupport.suppress.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.WeatherIntegration.DeicingDecisionSupport.suppress.success');

            return $this->success('suppress', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('DeicingDecisionSupport.suppress.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.WeatherIntegration.DeicingDecisionSupport.suppress.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('DeicingDecisionSupport.replay.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.WeatherIntegration.DeicingDecisionSupport.replay.success');

            return $this->success('replay', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('DeicingDecisionSupport.replay.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.WeatherIntegration.DeicingDecisionSupport.replay.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('DeicingDecisionSupport.hydrate.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.WeatherIntegration.DeicingDecisionSupport.hydrate.success');

            return $this->success('hydrate', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('DeicingDecisionSupport.hydrate.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.WeatherIntegration.DeicingDecisionSupport.hydrate.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('DeicingDecisionSupport.persist.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.WeatherIntegration.DeicingDecisionSupport.persist.success');

            return $this->success('persist', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('DeicingDecisionSupport.persist.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.WeatherIntegration.DeicingDecisionSupport.persist.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('DeicingDecisionSupport.invalidate.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.WeatherIntegration.DeicingDecisionSupport.invalidate.success');

            return $this->success('invalidate', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('DeicingDecisionSupport.invalidate.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.WeatherIntegration.DeicingDecisionSupport.invalidate.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('DeicingDecisionSupport.broadcast.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.WeatherIntegration.DeicingDecisionSupport.broadcast.success');

            return $this->success('broadcast', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('DeicingDecisionSupport.broadcast.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.WeatherIntegration.DeicingDecisionSupport.broadcast.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('DeicingDecisionSupport.compact.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.WeatherIntegration.DeicingDecisionSupport.compact.success');

            return $this->success('compact', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('DeicingDecisionSupport.compact.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.WeatherIntegration.DeicingDecisionSupport.compact.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('DeicingDecisionSupport.archiveBatch.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.WeatherIntegration.DeicingDecisionSupport.archiveBatch.success');

            return $this->success('archiveBatch', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('DeicingDecisionSupport.archiveBatch.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.WeatherIntegration.DeicingDecisionSupport.archiveBatch.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('DeicingDecisionSupport.evaluateRules.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.WeatherIntegration.DeicingDecisionSupport.evaluateRules.success');

            return $this->success('evaluateRules', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('DeicingDecisionSupport.evaluateRules.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.WeatherIntegration.DeicingDecisionSupport.evaluateRules.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('DeicingDecisionSupport.applyPolicy.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.WeatherIntegration.DeicingDecisionSupport.applyPolicy.success');

            return $this->success('applyPolicy', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('DeicingDecisionSupport.applyPolicy.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.WeatherIntegration.DeicingDecisionSupport.applyPolicy.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('DeicingDecisionSupport.computeMetrics.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.WeatherIntegration.DeicingDecisionSupport.computeMetrics.success');

            return $this->success('computeMetrics', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('DeicingDecisionSupport.computeMetrics.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.WeatherIntegration.DeicingDecisionSupport.computeMetrics.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('DeicingDecisionSupport.buildPayload.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.WeatherIntegration.DeicingDecisionSupport.buildPayload.success');

            return $this->success('buildPayload', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('DeicingDecisionSupport.buildPayload.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.WeatherIntegration.DeicingDecisionSupport.buildPayload.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('DeicingDecisionSupport.transformInput.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.WeatherIntegration.DeicingDecisionSupport.transformInput.success');

            return $this->success('transformInput', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('DeicingDecisionSupport.transformInput.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.WeatherIntegration.DeicingDecisionSupport.transformInput.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('DeicingDecisionSupport.transformOutput.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.WeatherIntegration.DeicingDecisionSupport.transformOutput.success');

            return $this->success('transformOutput', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('DeicingDecisionSupport.transformOutput.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.WeatherIntegration.DeicingDecisionSupport.transformOutput.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('DeicingDecisionSupport.checkPreconditions.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.WeatherIntegration.DeicingDecisionSupport.checkPreconditions.success');

            return $this->success('checkPreconditions', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('DeicingDecisionSupport.checkPreconditions.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.WeatherIntegration.DeicingDecisionSupport.checkPreconditions.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('DeicingDecisionSupport.checkPostconditions.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.WeatherIntegration.DeicingDecisionSupport.checkPostconditions.success');

            return $this->success('checkPostconditions', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('DeicingDecisionSupport.checkPostconditions.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.WeatherIntegration.DeicingDecisionSupport.checkPostconditions.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('DeicingDecisionSupport.reserveResources.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.WeatherIntegration.DeicingDecisionSupport.reserveResources.success');

            return $this->success('reserveResources', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('DeicingDecisionSupport.reserveResources.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.WeatherIntegration.DeicingDecisionSupport.reserveResources.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('DeicingDecisionSupport.releaseResources.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.WeatherIntegration.DeicingDecisionSupport.releaseResources.success');

            return $this->success('releaseResources', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('DeicingDecisionSupport.releaseResources.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.WeatherIntegration.DeicingDecisionSupport.releaseResources.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('DeicingDecisionSupport.lockEntity.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.WeatherIntegration.DeicingDecisionSupport.lockEntity.success');

            return $this->success('lockEntity', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('DeicingDecisionSupport.lockEntity.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.WeatherIntegration.DeicingDecisionSupport.lockEntity.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('DeicingDecisionSupport.unlockEntity.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.WeatherIntegration.DeicingDecisionSupport.unlockEntity.success');

            return $this->success('unlockEntity', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('DeicingDecisionSupport.unlockEntity.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.WeatherIntegration.DeicingDecisionSupport.unlockEntity.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('DeicingDecisionSupport.queueFollowUp.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.WeatherIntegration.DeicingDecisionSupport.queueFollowUp.success');

            return $this->success('queueFollowUp', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('DeicingDecisionSupport.queueFollowUp.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.WeatherIntegration.DeicingDecisionSupport.queueFollowUp.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('DeicingDecisionSupport.scheduleRetry.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.WeatherIntegration.DeicingDecisionSupport.scheduleRetry.success');

            return $this->success('scheduleRetry', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('DeicingDecisionSupport.scheduleRetry.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.WeatherIntegration.DeicingDecisionSupport.scheduleRetry.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('DeicingDecisionSupport.markComplete.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.WeatherIntegration.DeicingDecisionSupport.markComplete.success');

            return $this->success('markComplete', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('DeicingDecisionSupport.markComplete.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.WeatherIntegration.DeicingDecisionSupport.markComplete.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('DeicingDecisionSupport.markFailed.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.WeatherIntegration.DeicingDecisionSupport.markFailed.success');

            return $this->success('markFailed', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('DeicingDecisionSupport.markFailed.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.WeatherIntegration.DeicingDecisionSupport.markFailed.failure');
    ...
    {
        $cacheKey = sprintf('domain:WeatherIntegration:DeicingDecisionSupport:%s:%s', $verb, md5(json_encode($context['payload'])));
    ...
    protected function compute(string $verb, array $context): array
    {
        ...
        return [
            'service' => 'DeicingDecisionSupport',
            'module' => 'WeatherIntegration',
            'verb' => $verb,
    ...
    protected function buildRecommendations(string $verb, float $score, array $payload): array
    {
        $recs = [];
        if ($score > 100) {
            $recs[] = ['code' => 'HIGH_LOAD', 'message' => 'High operational load detected for DeicingDecisionSupport'];
        }
    ...
    protected function afterHook(string $verb, array $context, array $result): void
    {
        if (in_array($verb, ['publish', 'broadcast', 'escalate'], true)) {
            $this->logger->info('DeicingDecisionSupport.after.'.$verb, [
                'correlation_id' => $context['correlation_id'],
