...
/**
 * Domain service: OnTimePerformanceService
 * Module: Analytics
 *
 * Encapsulates operational workflows for airline Analytics processes.
 */
class OnTimePerformanceService
{
    protected $logger;
    ...
    public function execute(array $context = []): array
    {
        ...
        $this->logger->info('OnTimePerformanceService.execute.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.Analytics.OnTimePerformanceService.execute.success');

            return $this->success('execute', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('OnTimePerformanceService.execute.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.Analytics.OnTimePerformanceService.execute.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('OnTimePerformanceService.validate.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.Analytics.OnTimePerformanceService.validate.success');

            return $this->success('validate', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('OnTimePerformanceService.validate.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.Analytics.OnTimePerformanceService.validate.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('OnTimePerformanceService.simulate.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.Analytics.OnTimePerformanceService.simulate.success');

            return $this->success('simulate', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('OnTimePerformanceService.simulate.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.Analytics.OnTimePerformanceService.simulate.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('OnTimePerformanceService.reconcile.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.Analytics.OnTimePerformanceService.reconcile.success');

            return $this->success('reconcile', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('OnTimePerformanceService.reconcile.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.Analytics.OnTimePerformanceService.reconcile.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('OnTimePerformanceService.optimize.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.Analytics.OnTimePerformanceService.optimize.success');

            return $this->success('optimize', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('OnTimePerformanceService.optimize.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.Analytics.OnTimePerformanceService.optimize.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('OnTimePerformanceService.forecast.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.Analytics.OnTimePerformanceService.forecast.success');

            return $this->success('forecast', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('OnTimePerformanceService.forecast.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.Analytics.OnTimePerformanceService.forecast.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('OnTimePerformanceService.publish.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.Analytics.OnTimePerformanceService.publish.success');

            return $this->success('publish', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('OnTimePerformanceService.publish.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.Analytics.OnTimePerformanceService.publish.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('OnTimePerformanceService.rollback.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.Analytics.OnTimePerformanceService.rollback.success');

            return $this->success('rollback', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('OnTimePerformanceService.rollback.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.Analytics.OnTimePerformanceService.rollback.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('OnTimePerformanceService.snapshot.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.Analytics.OnTimePerformanceService.snapshot.success');

            return $this->success('snapshot', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('OnTimePerformanceService.snapshot.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.Analytics.OnTimePerformanceService.snapshot.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('OnTimePerformanceService.diff.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.Analytics.OnTimePerformanceService.diff.success');

            return $this->success('diff', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('OnTimePerformanceService.diff.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.Analytics.OnTimePerformanceService.diff.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('OnTimePerformanceService.enrich.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.Analytics.OnTimePerformanceService.enrich.success');

            return $this->success('enrich', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('OnTimePerformanceService.enrich.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.Analytics.OnTimePerformanceService.enrich.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('OnTimePerformanceService.normalize.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.Analytics.OnTimePerformanceService.normalize.success');

            return $this->success('normalize', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('OnTimePerformanceService.normalize.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.Analytics.OnTimePerformanceService.normalize.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('OnTimePerformanceService.aggregate.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.Analytics.OnTimePerformanceService.aggregate.success');

            return $this->success('aggregate', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('OnTimePerformanceService.aggregate.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.Analytics.OnTimePerformanceService.aggregate.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('OnTimePerformanceService.dispatch.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.Analytics.OnTimePerformanceService.dispatch.success');

            return $this->success('dispatch', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('OnTimePerformanceService.dispatch.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.Analytics.OnTimePerformanceService.dispatch.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('OnTimePerformanceService.acknowledge.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.Analytics.OnTimePerformanceService.acknowledge.success');

            return $this->success('acknowledge', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('OnTimePerformanceService.acknowledge.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.Analytics.OnTimePerformanceService.acknowledge.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('OnTimePerformanceService.escalate.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.Analytics.OnTimePerformanceService.escalate.success');

            return $this->success('escalate', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('OnTimePerformanceService.escalate.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.Analytics.OnTimePerformanceService.escalate.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('OnTimePerformanceService.suppress.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.Analytics.OnTimePerformanceService.suppress.success');

            return $this->success('suppress', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('OnTimePerformanceService.suppress.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.Analytics.OnTimePerformanceService.suppress.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('OnTimePerformanceService.replay.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.Analytics.OnTimePerformanceService.replay.success');

            return $this->success('replay', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('OnTimePerformanceService.replay.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.Analytics.OnTimePerformanceService.replay.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('OnTimePerformanceService.hydrate.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.Analytics.OnTimePerformanceService.hydrate.success');

            return $this->success('hydrate', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('OnTimePerformanceService.hydrate.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.Analytics.OnTimePerformanceService.hydrate.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('OnTimePerformanceService.persist.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.Analytics.OnTimePerformanceService.persist.success');

            return $this->success('persist', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('OnTimePerformanceService.persist.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.Analytics.OnTimePerformanceService.persist.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('OnTimePerformanceService.invalidate.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.Analytics.OnTimePerformanceService.invalidate.success');

            return $this->success('invalidate', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('OnTimePerformanceService.invalidate.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.Analytics.OnTimePerformanceService.invalidate.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('OnTimePerformanceService.broadcast.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.Analytics.OnTimePerformanceService.broadcast.success');

            return $this->success('broadcast', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('OnTimePerformanceService.broadcast.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.Analytics.OnTimePerformanceService.broadcast.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('OnTimePerformanceService.compact.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.Analytics.OnTimePerformanceService.compact.success');

            return $this->success('compact', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('OnTimePerformanceService.compact.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.Analytics.OnTimePerformanceService.compact.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('OnTimePerformanceService.archiveBatch.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.Analytics.OnTimePerformanceService.archiveBatch.success');

            return $this->success('archiveBatch', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('OnTimePerformanceService.archiveBatch.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.Analytics.OnTimePerformanceService.archiveBatch.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('OnTimePerformanceService.evaluateRules.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.Analytics.OnTimePerformanceService.evaluateRules.success');

            return $this->success('evaluateRules', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('OnTimePerformanceService.evaluateRules.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.Analytics.OnTimePerformanceService.evaluateRules.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('OnTimePerformanceService.applyPolicy.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.Analytics.OnTimePerformanceService.applyPolicy.success');

            return $this->success('applyPolicy', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('OnTimePerformanceService.applyPolicy.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.Analytics.OnTimePerformanceService.applyPolicy.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('OnTimePerformanceService.computeMetrics.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.Analytics.OnTimePerformanceService.computeMetrics.success');

            return $this->success('computeMetrics', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('OnTimePerformanceService.computeMetrics.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.Analytics.OnTimePerformanceService.computeMetrics.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('OnTimePerformanceService.buildPayload.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.Analytics.OnTimePerformanceService.buildPayload.success');

            return $this->success('buildPayload', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('OnTimePerformanceService.buildPayload.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.Analytics.OnTimePerformanceService.buildPayload.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('OnTimePerformanceService.transformInput.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.Analytics.OnTimePerformanceService.transformInput.success');

            return $this->success('transformInput', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('OnTimePerformanceService.transformInput.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.Analytics.OnTimePerformanceService.transformInput.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('OnTimePerformanceService.transformOutput.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.Analytics.OnTimePerformanceService.transformOutput.success');

            return $this->success('transformOutput', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('OnTimePerformanceService.transformOutput.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.Analytics.OnTimePerformanceService.transformOutput.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('OnTimePerformanceService.checkPreconditions.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.Analytics.OnTimePerformanceService.checkPreconditions.success');

            return $this->success('checkPreconditions', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('OnTimePerformanceService.checkPreconditions.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.Analytics.OnTimePerformanceService.checkPreconditions.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('OnTimePerformanceService.checkPostconditions.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.Analytics.OnTimePerformanceService.checkPostconditions.success');

            return $this->success('checkPostconditions', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('OnTimePerformanceService.checkPostconditions.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.Analytics.OnTimePerformanceService.checkPostconditions.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('OnTimePerformanceService.reserveResources.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.Analytics.OnTimePerformanceService.reserveResources.success');

            return $this->success('reserveResources', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('OnTimePerformanceService.reserveResources.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.Analytics.OnTimePerformanceService.reserveResources.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('OnTimePerformanceService.releaseResources.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.Analytics.OnTimePerformanceService.releaseResources.success');

            return $this->success('releaseResources', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('OnTimePerformanceService.releaseResources.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.Analytics.OnTimePerformanceService.releaseResources.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('OnTimePerformanceService.lockEntity.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.Analytics.OnTimePerformanceService.lockEntity.success');

            return $this->success('lockEntity', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('OnTimePerformanceService.lockEntity.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.Analytics.OnTimePerformanceService.lockEntity.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('OnTimePerformanceService.unlockEntity.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.Analytics.OnTimePerformanceService.unlockEntity.success');

            return $this->success('unlockEntity', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('OnTimePerformanceService.unlockEntity.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.Analytics.OnTimePerformanceService.unlockEntity.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('OnTimePerformanceService.queueFollowUp.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.Analytics.OnTimePerformanceService.queueFollowUp.success');

            return $this->success('queueFollowUp', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('OnTimePerformanceService.queueFollowUp.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.Analytics.OnTimePerformanceService.queueFollowUp.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('OnTimePerformanceService.scheduleRetry.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.Analytics.OnTimePerformanceService.scheduleRetry.success');

            return $this->success('scheduleRetry', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('OnTimePerformanceService.scheduleRetry.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.Analytics.OnTimePerformanceService.scheduleRetry.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('OnTimePerformanceService.markComplete.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.Analytics.OnTimePerformanceService.markComplete.success');

            return $this->success('markComplete', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('OnTimePerformanceService.markComplete.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.Analytics.OnTimePerformanceService.markComplete.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('OnTimePerformanceService.markFailed.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.Analytics.OnTimePerformanceService.markFailed.success');

            return $this->success('markFailed', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('OnTimePerformanceService.markFailed.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.Analytics.OnTimePerformanceService.markFailed.failure');
    ...
    {
        $cacheKey = sprintf('domain:Analytics:OnTimePerformanceService:%s:%s', $verb, md5(json_encode($context['payload'])));
    ...
    protected function compute(string $verb, array $context): array
    {
        ...
        return [
            'service' => 'OnTimePerformanceService',
            'module' => 'Analytics',
            'verb' => $verb,
    ...
    protected function buildRecommendations(string $verb, float $score, array $payload): array
    {
        $recs = [];
        if ($score > 100) {
            $recs[] = ['code' => 'HIGH_LOAD', 'message' => 'High operational load detected for OnTimePerformanceService'];
        }
    ...
    protected function afterHook(string $verb, array $context, array $result): void
    {
        if (in_array($verb, ['publish', 'broadcast', 'escalate'], true)) {
            $this->logger->info('OnTimePerformanceService.after.'.$verb, [
                'correlation_id' => $context['correlation_id'],
