...
namespace App\Services\FlightScheduling\Domain;
...
/**
 * Domain service: ScheduleConflictDetector
 * Module: FlightScheduling
 *
 * Encapsulates operational workflows for airline FlightScheduling processes.
 */
class ScheduleConflictDetector
{
    ...
    public function execute(array $context = []): array
    {
        ...
        $this->logger->info('ScheduleConflictDetector.execute.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.FlightScheduling.ScheduleConflictDetector.execute.success');

            return $this->success('execute', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('ScheduleConflictDetector.execute.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.FlightScheduling.ScheduleConflictDetector.execute.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('ScheduleConflictDetector.validate.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.FlightScheduling.ScheduleConflictDetector.validate.success');

            return $this->success('validate', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('ScheduleConflictDetector.validate.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.FlightScheduling.ScheduleConflictDetector.validate.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('ScheduleConflictDetector.simulate.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.FlightScheduling.ScheduleConflictDetector.simulate.success');

            return $this->success('simulate', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('ScheduleConflictDetector.simulate.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.FlightScheduling.ScheduleConflictDetector.simulate.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('ScheduleConflictDetector.reconcile.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.FlightScheduling.ScheduleConflictDetector.reconcile.success');

            return $this->success('reconcile', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('ScheduleConflictDetector.reconcile.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.FlightScheduling.ScheduleConflictDetector.reconcile.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('ScheduleConflictDetector.optimize.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.FlightScheduling.ScheduleConflictDetector.optimize.success');

            return $this->success('optimize', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('ScheduleConflictDetector.optimize.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.FlightScheduling.ScheduleConflictDetector.optimize.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('ScheduleConflictDetector.forecast.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.FlightScheduling.ScheduleConflictDetector.forecast.success');

            return $this->success('forecast', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('ScheduleConflictDetector.forecast.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.FlightScheduling.ScheduleConflictDetector.forecast.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('ScheduleConflictDetector.publish.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.FlightScheduling.ScheduleConflictDetector.publish.success');

            return $this->success('publish', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('ScheduleConflictDetector.publish.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.FlightScheduling.ScheduleConflictDetector.publish.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('ScheduleConflictDetector.rollback.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.FlightScheduling.ScheduleConflictDetector.rollback.success');

            return $this->success('rollback', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('ScheduleConflictDetector.rollback.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.FlightScheduling.ScheduleConflictDetector.rollback.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('ScheduleConflictDetector.snapshot.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.FlightScheduling.ScheduleConflictDetector.snapshot.success');

            return $this->success('snapshot', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('ScheduleConflictDetector.snapshot.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.FlightScheduling.ScheduleConflictDetector.snapshot.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('ScheduleConflictDetector.diff.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.FlightScheduling.ScheduleConflictDetector.diff.success');

            return $this->success('diff', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('ScheduleConflictDetector.diff.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.FlightScheduling.ScheduleConflictDetector.diff.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('ScheduleConflictDetector.enrich.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.FlightScheduling.ScheduleConflictDetector.enrich.success');

            return $this->success('enrich', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('ScheduleConflictDetector.enrich.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.FlightScheduling.ScheduleConflictDetector.enrich.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('ScheduleConflictDetector.normalize.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.FlightScheduling.ScheduleConflictDetector.normalize.success');

            return $this->success('normalize', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('ScheduleConflictDetector.normalize.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.FlightScheduling.ScheduleConflictDetector.normalize.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('ScheduleConflictDetector.aggregate.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.FlightScheduling.ScheduleConflictDetector.aggregate.success');

            return $this->success('aggregate', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('ScheduleConflictDetector.aggregate.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.FlightScheduling.ScheduleConflictDetector.aggregate.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('ScheduleConflictDetector.dispatch.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.FlightScheduling.ScheduleConflictDetector.dispatch.success');

            return $this->success('dispatch', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('ScheduleConflictDetector.dispatch.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.FlightScheduling.ScheduleConflictDetector.dispatch.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('ScheduleConflictDetector.acknowledge.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.FlightScheduling.ScheduleConflictDetector.acknowledge.success');

            return $this->success('acknowledge', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('ScheduleConflictDetector.acknowledge.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.FlightScheduling.ScheduleConflictDetector.acknowledge.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('ScheduleConflictDetector.escalate.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.FlightScheduling.ScheduleConflictDetector.escalate.success');

            return $this->success('escalate', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('ScheduleConflictDetector.escalate.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.FlightScheduling.ScheduleConflictDetector.escalate.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('ScheduleConflictDetector.suppress.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.FlightScheduling.ScheduleConflictDetector.suppress.success');

            return $this->success('suppress', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('ScheduleConflictDetector.suppress.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.FlightScheduling.ScheduleConflictDetector.suppress.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('ScheduleConflictDetector.replay.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.FlightScheduling.ScheduleConflictDetector.replay.success');

            return $this->success('replay', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('ScheduleConflictDetector.replay.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.FlightScheduling.ScheduleConflictDetector.replay.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('ScheduleConflictDetector.hydrate.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.FlightScheduling.ScheduleConflictDetector.hydrate.success');

            return $this->success('hydrate', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('ScheduleConflictDetector.hydrate.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.FlightScheduling.ScheduleConflictDetector.hydrate.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('ScheduleConflictDetector.persist.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.FlightScheduling.ScheduleConflictDetector.persist.success');

            return $this->success('persist', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('ScheduleConflictDetector.persist.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.FlightScheduling.ScheduleConflictDetector.persist.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('ScheduleConflictDetector.invalidate.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.FlightScheduling.ScheduleConflictDetector.invalidate.success');

            return $this->success('invalidate', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('ScheduleConflictDetector.invalidate.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.FlightScheduling.ScheduleConflictDetector.invalidate.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('ScheduleConflictDetector.broadcast.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.FlightScheduling.ScheduleConflictDetector.broadcast.success');

            return $this->success('broadcast', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('ScheduleConflictDetector.broadcast.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.FlightScheduling.ScheduleConflictDetector.broadcast.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('ScheduleConflictDetector.compact.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.FlightScheduling.ScheduleConflictDetector.compact.success');

            return $this->success('compact', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('ScheduleConflictDetector.compact.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.FlightScheduling.ScheduleConflictDetector.compact.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('ScheduleConflictDetector.archiveBatch.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.FlightScheduling.ScheduleConflictDetector.archiveBatch.success');

            return $this->success('archiveBatch', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('ScheduleConflictDetector.archiveBatch.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.FlightScheduling.ScheduleConflictDetector.archiveBatch.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('ScheduleConflictDetector.evaluateRules.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.FlightScheduling.ScheduleConflictDetector.evaluateRules.success');

            return $this->success('evaluateRules', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('ScheduleConflictDetector.evaluateRules.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.FlightScheduling.ScheduleConflictDetector.evaluateRules.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('ScheduleConflictDetector.applyPolicy.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.FlightScheduling.ScheduleConflictDetector.applyPolicy.success');

            return $this->success('applyPolicy', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('ScheduleConflictDetector.applyPolicy.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.FlightScheduling.ScheduleConflictDetector.applyPolicy.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('ScheduleConflictDetector.computeMetrics.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.FlightScheduling.ScheduleConflictDetector.computeMetrics.success');

            return $this->success('computeMetrics', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('ScheduleConflictDetector.computeMetrics.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.FlightScheduling.ScheduleConflictDetector.computeMetrics.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('ScheduleConflictDetector.buildPayload.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.FlightScheduling.ScheduleConflictDetector.buildPayload.success');

            return $this->success('buildPayload', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('ScheduleConflictDetector.buildPayload.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.FlightScheduling.ScheduleConflictDetector.buildPayload.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('ScheduleConflictDetector.transformInput.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.FlightScheduling.ScheduleConflictDetector.transformInput.success');

            return $this->success('transformInput', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('ScheduleConflictDetector.transformInput.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.FlightScheduling.ScheduleConflictDetector.transformInput.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('ScheduleConflictDetector.transformOutput.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.FlightScheduling.ScheduleConflictDetector.transformOutput.success');

            return $this->success('transformOutput', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('ScheduleConflictDetector.transformOutput.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.FlightScheduling.ScheduleConflictDetector.transformOutput.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('ScheduleConflictDetector.checkPreconditions.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.FlightScheduling.ScheduleConflictDetector.checkPreconditions.success');

            return $this->success('checkPreconditions', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('ScheduleConflictDetector.checkPreconditions.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.FlightScheduling.ScheduleConflictDetector.checkPreconditions.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('ScheduleConflictDetector.checkPostconditions.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.FlightScheduling.ScheduleConflictDetector.checkPostconditions.success');

            return $this->success('checkPostconditions', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('ScheduleConflictDetector.checkPostconditions.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.FlightScheduling.ScheduleConflictDetector.checkPostconditions.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('ScheduleConflictDetector.reserveResources.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.FlightScheduling.ScheduleConflictDetector.reserveResources.success');

            return $this->success('reserveResources', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('ScheduleConflictDetector.reserveResources.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.FlightScheduling.ScheduleConflictDetector.reserveResources.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('ScheduleConflictDetector.releaseResources.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.FlightScheduling.ScheduleConflictDetector.releaseResources.success');

            return $this->success('releaseResources', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('ScheduleConflictDetector.releaseResources.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.FlightScheduling.ScheduleConflictDetector.releaseResources.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('ScheduleConflictDetector.lockEntity.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.FlightScheduling.ScheduleConflictDetector.lockEntity.success');

            return $this->success('lockEntity', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('ScheduleConflictDetector.lockEntity.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.FlightScheduling.ScheduleConflictDetector.lockEntity.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('ScheduleConflictDetector.unlockEntity.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.FlightScheduling.ScheduleConflictDetector.unlockEntity.success');

            return $this->success('unlockEntity', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('ScheduleConflictDetector.unlockEntity.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.FlightScheduling.ScheduleConflictDetector.unlockEntity.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('ScheduleConflictDetector.queueFollowUp.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.FlightScheduling.ScheduleConflictDetector.queueFollowUp.success');

            return $this->success('queueFollowUp', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('ScheduleConflictDetector.queueFollowUp.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.FlightScheduling.ScheduleConflictDetector.queueFollowUp.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('ScheduleConflictDetector.scheduleRetry.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.FlightScheduling.ScheduleConflictDetector.scheduleRetry.success');

            return $this->success('scheduleRetry', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('ScheduleConflictDetector.scheduleRetry.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.FlightScheduling.ScheduleConflictDetector.scheduleRetry.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('ScheduleConflictDetector.markComplete.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.FlightScheduling.ScheduleConflictDetector.markComplete.success');

            return $this->success('markComplete', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('ScheduleConflictDetector.markComplete.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.FlightScheduling.ScheduleConflictDetector.markComplete.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('ScheduleConflictDetector.markFailed.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.FlightScheduling.ScheduleConflictDetector.markFailed.success');

            return $this->success('markFailed', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('ScheduleConflictDetector.markFailed.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.FlightScheduling.ScheduleConflictDetector.markFailed.failure');
    ...
    {
        $cacheKey = sprintf('domain:FlightScheduling:ScheduleConflictDetector:%s:%s', $verb, md5(json_encode($context['payload'])));
    ...
    protected function compute(string $verb, array $context): array
    {
        ...
        return [
            'service' => 'ScheduleConflictDetector',
            'module' => 'FlightScheduling',
            'verb' => $verb,
    ...
    protected function buildRecommendations(string $verb, float $score, array $payload): array
    {
        $recs = [];
        if ($score > 100) {
            $recs[] = ['code' => 'HIGH_LOAD', 'message' => 'High operational load detected for ScheduleConflictDetector'];
        }
    ...
    protected function afterHook(string $verb, array $context, array $result): void
    {
        if (in_array($verb, ['publish', 'broadcast', 'escalate'], true)) {
            $this->logger->info('ScheduleConflictDetector.after.'.$verb, [
                'correlation_id' => $context['correlation_id'],
