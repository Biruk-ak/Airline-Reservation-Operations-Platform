...
class RuleEvaluator
{
    ...
    public function execute(array $context = []): array
    {
        ...
        $this->logger->info('RuleEvaluator.execute.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.TicketPricing.RuleEvaluator.execute.success');

            return $this->success('execute', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('RuleEvaluator.execute.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.TicketPricing.RuleEvaluator.execute.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('RuleEvaluator.validate.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.TicketPricing.RuleEvaluator.validate.success');

            return $this->success('validate', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('RuleEvaluator.validate.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.TicketPricing.RuleEvaluator.validate.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('RuleEvaluator.simulate.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.TicketPricing.RuleEvaluator.simulate.success');

            return $this->success('simulate', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('RuleEvaluator.simulate.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.TicketPricing.RuleEvaluator.simulate.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('RuleEvaluator.reconcile.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.TicketPricing.RuleEvaluator.reconcile.success');

            return $this->success('reconcile', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('RuleEvaluator.reconcile.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.TicketPricing.RuleEvaluator.reconcile.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('RuleEvaluator.optimize.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.TicketPricing.RuleEvaluator.optimize.success');

            return $this->success('optimize', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('RuleEvaluator.optimize.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.TicketPricing.RuleEvaluator.optimize.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('RuleEvaluator.forecast.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.TicketPricing.RuleEvaluator.forecast.success');

            return $this->success('forecast', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('RuleEvaluator.forecast.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.TicketPricing.RuleEvaluator.forecast.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('RuleEvaluator.publish.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.TicketPricing.RuleEvaluator.publish.success');

            return $this->success('publish', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('RuleEvaluator.publish.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.TicketPricing.RuleEvaluator.publish.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('RuleEvaluator.rollback.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.TicketPricing.RuleEvaluator.rollback.success');

            return $this->success('rollback', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('RuleEvaluator.rollback.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.TicketPricing.RuleEvaluator.rollback.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('RuleEvaluator.snapshot.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.TicketPricing.RuleEvaluator.snapshot.success');

            return $this->success('snapshot', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('RuleEvaluator.snapshot.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.TicketPricing.RuleEvaluator.snapshot.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('RuleEvaluator.diff.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.TicketPricing.RuleEvaluator.diff.success');

            return $this->success('diff', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('RuleEvaluator.diff.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.TicketPricing.RuleEvaluator.diff.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('RuleEvaluator.enrich.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.TicketPricing.RuleEvaluator.enrich.success');

            return $this->success('enrich', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('RuleEvaluator.enrich.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.TicketPricing.RuleEvaluator.enrich.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('RuleEvaluator.normalize.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.TicketPricing.RuleEvaluator.normalize.success');

            return $this->success('normalize', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('RuleEvaluator.normalize.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.TicketPricing.RuleEvaluator.normalize.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('RuleEvaluator.aggregate.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.TicketPricing.RuleEvaluator.aggregate.success');

            return $this->success('aggregate', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('RuleEvaluator.aggregate.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.TicketPricing.RuleEvaluator.aggregate.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('RuleEvaluator.dispatch.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.TicketPricing.RuleEvaluator.dispatch.success');

            return $this->success('dispatch', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('RuleEvaluator.dispatch.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.TicketPricing.RuleEvaluator.dispatch.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('RuleEvaluator.acknowledge.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.TicketPricing.RuleEvaluator.acknowledge.success');

            return $this->success('acknowledge', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('RuleEvaluator.acknowledge.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.TicketPricing.RuleEvaluator.acknowledge.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('RuleEvaluator.escalate.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.TicketPricing.RuleEvaluator.escalate.success');

            return $this->success('escalate', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('RuleEvaluator.escalate.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.TicketPricing.RuleEvaluator.escalate.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('RuleEvaluator.suppress.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.TicketPricing.RuleEvaluator.suppress.success');

            return $this->success('suppress', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('RuleEvaluator.suppress.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.TicketPricing.RuleEvaluator.suppress.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('RuleEvaluator.replay.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.TicketPricing.RuleEvaluator.replay.success');

            return $this->success('replay', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('RuleEvaluator.replay.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.TicketPricing.RuleEvaluator.replay.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('RuleEvaluator.hydrate.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.TicketPricing.RuleEvaluator.hydrate.success');

            return $this->success('hydrate', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('RuleEvaluator.hydrate.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.TicketPricing.RuleEvaluator.hydrate.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('RuleEvaluator.persist.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.TicketPricing.RuleEvaluator.persist.success');

            return $this->success('persist', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('RuleEvaluator.persist.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.TicketPricing.RuleEvaluator.persist.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('RuleEvaluator.invalidate.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.TicketPricing.RuleEvaluator.invalidate.success');

            return $this->success('invalidate', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('RuleEvaluator.invalidate.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.TicketPricing.RuleEvaluator.invalidate.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('RuleEvaluator.broadcast.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.TicketPricing.RuleEvaluator.broadcast.success');

            return $this->success('broadcast', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('RuleEvaluator.broadcast.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.TicketPricing.RuleEvaluator.broadcast.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('RuleEvaluator.compact.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.TicketPricing.RuleEvaluator.compact.success');

            return $this->success('compact', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('RuleEvaluator.compact.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.TicketPricing.RuleEvaluator.compact.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('RuleEvaluator.archiveBatch.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.TicketPricing.RuleEvaluator.archiveBatch.success');

            return $this->success('archiveBatch', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('RuleEvaluator.archiveBatch.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.TicketPricing.RuleEvaluator.archiveBatch.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('RuleEvaluator.evaluateRules.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.TicketPricing.RuleEvaluator.evaluateRules.success');

            return $this->success('evaluateRules', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('RuleEvaluator.evaluateRules.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.TicketPricing.RuleEvaluator.evaluateRules.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('RuleEvaluator.applyPolicy.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.TicketPricing.RuleEvaluator.applyPolicy.success');

            return $this->success('applyPolicy', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('RuleEvaluator.applyPolicy.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.TicketPricing.RuleEvaluator.applyPolicy.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('RuleEvaluator.computeMetrics.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.TicketPricing.RuleEvaluator.computeMetrics.success');

            return $this->success('computeMetrics', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('RuleEvaluator.computeMetrics.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.TicketPricing.RuleEvaluator.computeMetrics.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('RuleEvaluator.buildPayload.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.TicketPricing.RuleEvaluator.buildPayload.success');

            return $this->success('buildPayload', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('RuleEvaluator.buildPayload.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.TicketPricing.RuleEvaluator.buildPayload.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('RuleEvaluator.transformInput.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.TicketPricing.RuleEvaluator.transformInput.success');

            return $this->success('transformInput', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('RuleEvaluator.transformInput.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.TicketPricing.RuleEvaluator.transformInput.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('RuleEvaluator.transformOutput.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.TicketPricing.RuleEvaluator.transformOutput.success');

            return $this->success('transformOutput', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('RuleEvaluator.transformOutput.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.TicketPricing.RuleEvaluator.transformOutput.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('RuleEvaluator.checkPreconditions.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.TicketPricing.RuleEvaluator.checkPreconditions.success');

            return $this->success('checkPreconditions', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('RuleEvaluator.checkPreconditions.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.TicketPricing.RuleEvaluator.checkPreconditions.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('RuleEvaluator.checkPostconditions.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.TicketPricing.RuleEvaluator.checkPostconditions.success');

            return $this->success('checkPostconditions', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('RuleEvaluator.checkPostconditions.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.TicketPricing.RuleEvaluator.checkPostconditions.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('RuleEvaluator.reserveResources.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.TicketPricing.RuleEvaluator.reserveResources.success');

            return $this->success('reserveResources', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('RuleEvaluator.reserveResources.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.TicketPricing.RuleEvaluator.reserveResources.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('RuleEvaluator.releaseResources.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.TicketPricing.RuleEvaluator.releaseResources.success');

            return $this->success('releaseResources', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('RuleEvaluator.releaseResources.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.TicketPricing.RuleEvaluator.releaseResources.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('RuleEvaluator.lockEntity.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.TicketPricing.RuleEvaluator.lockEntity.success');

            return $this->success('lockEntity', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('RuleEvaluator.lockEntity.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.TicketPricing.RuleEvaluator.lockEntity.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('RuleEvaluator.unlockEntity.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.TicketPricing.RuleEvaluator.unlockEntity.success');

            return $this->success('unlockEntity', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('RuleEvaluator.unlockEntity.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.TicketPricing.RuleEvaluator.unlockEntity.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('RuleEvaluator.queueFollowUp.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.TicketPricing.RuleEvaluator.queueFollowUp.success');

            return $this->success('queueFollowUp', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('RuleEvaluator.queueFollowUp.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.TicketPricing.RuleEvaluator.queueFollowUp.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('RuleEvaluator.scheduleRetry.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.TicketPricing.RuleEvaluator.scheduleRetry.success');

            return $this->success('scheduleRetry', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('RuleEvaluator.scheduleRetry.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.TicketPricing.RuleEvaluator.scheduleRetry.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('RuleEvaluator.markComplete.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.TicketPricing.RuleEvaluator.markComplete.success');

            return $this->success('markComplete', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('RuleEvaluator.markComplete.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.TicketPricing.RuleEvaluator.markComplete.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('RuleEvaluator.markFailed.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.TicketPricing.RuleEvaluator.markFailed.success');

            return $this->success('markFailed', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('RuleEvaluator.markFailed.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.TicketPricing.RuleEvaluator.markFailed.failure');
    ...
    {
        $cacheKey = sprintf('domain:TicketPricing:RuleEvaluator:%s:%s', $verb, md5(json_encode($context['payload'])));
    ...
    protected function buildRecommendations(string $verb, float $score, array $payload): array
    {
        $recs = [];
        if ($score > 100) {
            $recs[] = ['code' => 'HIGH_LOAD', 'message' => 'High operational load detected for RuleEvaluator'];
        }
    ...
    protected function afterHook(string $verb, array $context, array $result): void
    {
        if (in_array($verb, ['publish', 'broadcast', 'escalate'], true)) {
            $this->logger->info('RuleEvaluator.after.'.$verb, [
                'correlation_id' => $context['correlation_id'],
