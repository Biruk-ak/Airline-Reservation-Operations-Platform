...
/**
 * Domain service: StandbyProcessor
 * Module: CheckIn
 *
...
class StandbyProcessor
{
    ...
    public function execute(array $context = []): array
    {
        ...
        $this->logger->info('StandbyProcessor.execute.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.CheckIn.StandbyProcessor.execute.success');

            return $this->success('execute', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('StandbyProcessor.execute.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.CheckIn.StandbyProcessor.execute.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('StandbyProcessor.validate.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.CheckIn.StandbyProcessor.validate.success');

            return $this->success('validate', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('StandbyProcessor.validate.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.CheckIn.StandbyProcessor.validate.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('StandbyProcessor.simulate.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.CheckIn.StandbyProcessor.simulate.success');

            return $this->success('simulate', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('StandbyProcessor.simulate.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.CheckIn.StandbyProcessor.simulate.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('StandbyProcessor.reconcile.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.CheckIn.StandbyProcessor.reconcile.success');

            return $this->success('reconcile', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('StandbyProcessor.reconcile.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.CheckIn.StandbyProcessor.reconcile.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('StandbyProcessor.optimize.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.CheckIn.StandbyProcessor.optimize.success');

            return $this->success('optimize', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('StandbyProcessor.optimize.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.CheckIn.StandbyProcessor.optimize.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('StandbyProcessor.forecast.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.CheckIn.StandbyProcessor.forecast.success');

            return $this->success('forecast', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('StandbyProcessor.forecast.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.CheckIn.StandbyProcessor.forecast.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('StandbyProcessor.publish.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.CheckIn.StandbyProcessor.publish.success');

            return $this->success('publish', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('StandbyProcessor.publish.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.CheckIn.StandbyProcessor.publish.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('StandbyProcessor.rollback.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.CheckIn.StandbyProcessor.rollback.success');

            return $this->success('rollback', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('StandbyProcessor.rollback.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.CheckIn.StandbyProcessor.rollback.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('StandbyProcessor.snapshot.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.CheckIn.StandbyProcessor.snapshot.success');

            return $this->success('snapshot', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('StandbyProcessor.snapshot.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.CheckIn.StandbyProcessor.snapshot.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('StandbyProcessor.diff.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.CheckIn.StandbyProcessor.diff.success');

            return $this->success('diff', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('StandbyProcessor.diff.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.CheckIn.StandbyProcessor.diff.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('StandbyProcessor.enrich.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.CheckIn.StandbyProcessor.enrich.success');

            return $this->success('enrich', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('StandbyProcessor.enrich.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.CheckIn.StandbyProcessor.enrich.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('StandbyProcessor.normalize.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.CheckIn.StandbyProcessor.normalize.success');

            return $this->success('normalize', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('StandbyProcessor.normalize.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.CheckIn.StandbyProcessor.normalize.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('StandbyProcessor.aggregate.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.CheckIn.StandbyProcessor.aggregate.success');

            return $this->success('aggregate', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('StandbyProcessor.aggregate.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.CheckIn.StandbyProcessor.aggregate.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('StandbyProcessor.dispatch.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.CheckIn.StandbyProcessor.dispatch.success');

            return $this->success('dispatch', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('StandbyProcessor.dispatch.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.CheckIn.StandbyProcessor.dispatch.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('StandbyProcessor.acknowledge.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.CheckIn.StandbyProcessor.acknowledge.success');

            return $this->success('acknowledge', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('StandbyProcessor.acknowledge.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.CheckIn.StandbyProcessor.acknowledge.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('StandbyProcessor.escalate.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.CheckIn.StandbyProcessor.escalate.success');

            return $this->success('escalate', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('StandbyProcessor.escalate.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.CheckIn.StandbyProcessor.escalate.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('StandbyProcessor.suppress.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.CheckIn.StandbyProcessor.suppress.success');

            return $this->success('suppress', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('StandbyProcessor.suppress.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.CheckIn.StandbyProcessor.suppress.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('StandbyProcessor.replay.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.CheckIn.StandbyProcessor.replay.success');

            return $this->success('replay', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('StandbyProcessor.replay.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.CheckIn.StandbyProcessor.replay.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('StandbyProcessor.hydrate.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.CheckIn.StandbyProcessor.hydrate.success');

            return $this->success('hydrate', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('StandbyProcessor.hydrate.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.CheckIn.StandbyProcessor.hydrate.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('StandbyProcessor.persist.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.CheckIn.StandbyProcessor.persist.success');

            return $this->success('persist', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('StandbyProcessor.persist.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.CheckIn.StandbyProcessor.persist.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('StandbyProcessor.invalidate.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.CheckIn.StandbyProcessor.invalidate.success');

            return $this->success('invalidate', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('StandbyProcessor.invalidate.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.CheckIn.StandbyProcessor.invalidate.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('StandbyProcessor.broadcast.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.CheckIn.StandbyProcessor.broadcast.success');

            return $this->success('broadcast', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('StandbyProcessor.broadcast.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.CheckIn.StandbyProcessor.broadcast.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('StandbyProcessor.compact.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.CheckIn.StandbyProcessor.compact.success');

            return $this->success('compact', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('StandbyProcessor.compact.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.CheckIn.StandbyProcessor.compact.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('StandbyProcessor.archiveBatch.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.CheckIn.StandbyProcessor.archiveBatch.success');

            return $this->success('archiveBatch', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('StandbyProcessor.archiveBatch.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.CheckIn.StandbyProcessor.archiveBatch.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('StandbyProcessor.evaluateRules.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.CheckIn.StandbyProcessor.evaluateRules.success');

            return $this->success('evaluateRules', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('StandbyProcessor.evaluateRules.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.CheckIn.StandbyProcessor.evaluateRules.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('StandbyProcessor.applyPolicy.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.CheckIn.StandbyProcessor.applyPolicy.success');

            return $this->success('applyPolicy', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('StandbyProcessor.applyPolicy.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.CheckIn.StandbyProcessor.applyPolicy.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('StandbyProcessor.computeMetrics.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.CheckIn.StandbyProcessor.computeMetrics.success');

            return $this->success('computeMetrics', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('StandbyProcessor.computeMetrics.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.CheckIn.StandbyProcessor.computeMetrics.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('StandbyProcessor.buildPayload.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.CheckIn.StandbyProcessor.buildPayload.success');

            return $this->success('buildPayload', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('StandbyProcessor.buildPayload.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.CheckIn.StandbyProcessor.buildPayload.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('StandbyProcessor.transformInput.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.CheckIn.StandbyProcessor.transformInput.success');

            return $this->success('transformInput', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('StandbyProcessor.transformInput.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.CheckIn.StandbyProcessor.transformInput.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('StandbyProcessor.transformOutput.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.CheckIn.StandbyProcessor.transformOutput.success');

            return $this->success('transformOutput', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('StandbyProcessor.transformOutput.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.CheckIn.StandbyProcessor.transformOutput.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('StandbyProcessor.checkPreconditions.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.CheckIn.StandbyProcessor.checkPreconditions.success');

            return $this->success('checkPreconditions', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('StandbyProcessor.checkPreconditions.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.CheckIn.StandbyProcessor.checkPreconditions.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('StandbyProcessor.checkPostconditions.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.CheckIn.StandbyProcessor.checkPostconditions.success');

            return $this->success('checkPostconditions', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('StandbyProcessor.checkPostconditions.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.CheckIn.StandbyProcessor.checkPostconditions.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('StandbyProcessor.reserveResources.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.CheckIn.StandbyProcessor.reserveResources.success');

            return $this->success('reserveResources', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('StandbyProcessor.reserveResources.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.CheckIn.StandbyProcessor.reserveResources.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('StandbyProcessor.releaseResources.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.CheckIn.StandbyProcessor.releaseResources.success');

            return $this->success('releaseResources', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('StandbyProcessor.releaseResources.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.CheckIn.StandbyProcessor.releaseResources.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('StandbyProcessor.lockEntity.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.CheckIn.StandbyProcessor.lockEntity.success');

            return $this->success('lockEntity', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('StandbyProcessor.lockEntity.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.CheckIn.StandbyProcessor.lockEntity.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('StandbyProcessor.unlockEntity.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.CheckIn.StandbyProcessor.unlockEntity.success');

            return $this->success('unlockEntity', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('StandbyProcessor.unlockEntity.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.CheckIn.StandbyProcessor.unlockEntity.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('StandbyProcessor.queueFollowUp.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.CheckIn.StandbyProcessor.queueFollowUp.success');

            return $this->success('queueFollowUp', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('StandbyProcessor.queueFollowUp.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.CheckIn.StandbyProcessor.queueFollowUp.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('StandbyProcessor.scheduleRetry.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.CheckIn.StandbyProcessor.scheduleRetry.success');

            return $this->success('scheduleRetry', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('StandbyProcessor.scheduleRetry.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.CheckIn.StandbyProcessor.scheduleRetry.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('StandbyProcessor.markComplete.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.CheckIn.StandbyProcessor.markComplete.success');

            return $this->success('markComplete', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('StandbyProcessor.markComplete.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.CheckIn.StandbyProcessor.markComplete.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('StandbyProcessor.markFailed.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.CheckIn.StandbyProcessor.markFailed.success');

            return $this->success('markFailed', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('StandbyProcessor.markFailed.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.CheckIn.StandbyProcessor.markFailed.failure');
    ...
    {
        $cacheKey = sprintf('domain:CheckIn:StandbyProcessor:%s:%s', $verb, md5(json_encode($context['payload'])));
    ...
    protected function buildRecommendations(string $verb, float $score, array $payload): array
    {
        $recs = [];
        if ($score > 100) {
            $recs[] = ['code' => 'HIGH_LOAD', 'message' => 'High operational load detected for StandbyProcessor'];
        }
    ...
    protected function afterHook(string $verb, array $context, array $result): void
    {
        if (in_array($verb, ['publish', 'broadcast', 'escalate'], true)) {
            $this->logger->info('StandbyProcessor.after.'.$verb, [
                'correlation_id' => $context['correlation_id'],
