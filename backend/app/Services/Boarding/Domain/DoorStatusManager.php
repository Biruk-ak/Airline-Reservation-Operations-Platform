...
/**
 * Domain service: DoorStatusManager
 * Module: Boarding
 *
...
class DoorStatusManager
{
    ...
    public function execute(array $context = []): array
    {
        ...
        $this->logger->info('DoorStatusManager.execute.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.Boarding.DoorStatusManager.execute.success');

            return $this->success('execute', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('DoorStatusManager.execute.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.Boarding.DoorStatusManager.execute.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('DoorStatusManager.validate.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.Boarding.DoorStatusManager.validate.success');

            return $this->success('validate', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('DoorStatusManager.validate.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.Boarding.DoorStatusManager.validate.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('DoorStatusManager.simulate.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.Boarding.DoorStatusManager.simulate.success');

            return $this->success('simulate', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('DoorStatusManager.simulate.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.Boarding.DoorStatusManager.simulate.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('DoorStatusManager.reconcile.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.Boarding.DoorStatusManager.reconcile.success');

            return $this->success('reconcile', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('DoorStatusManager.reconcile.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.Boarding.DoorStatusManager.reconcile.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('DoorStatusManager.optimize.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.Boarding.DoorStatusManager.optimize.success');

            return $this->success('optimize', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('DoorStatusManager.optimize.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.Boarding.DoorStatusManager.optimize.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('DoorStatusManager.forecast.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.Boarding.DoorStatusManager.forecast.success');

            return $this->success('forecast', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('DoorStatusManager.forecast.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.Boarding.DoorStatusManager.forecast.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('DoorStatusManager.publish.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.Boarding.DoorStatusManager.publish.success');

            return $this->success('publish', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('DoorStatusManager.publish.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.Boarding.DoorStatusManager.publish.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('DoorStatusManager.rollback.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.Boarding.DoorStatusManager.rollback.success');

            return $this->success('rollback', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('DoorStatusManager.rollback.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.Boarding.DoorStatusManager.rollback.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('DoorStatusManager.snapshot.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.Boarding.DoorStatusManager.snapshot.success');

            return $this->success('snapshot', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('DoorStatusManager.snapshot.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.Boarding.DoorStatusManager.snapshot.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('DoorStatusManager.diff.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.Boarding.DoorStatusManager.diff.success');

            return $this->success('diff', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('DoorStatusManager.diff.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.Boarding.DoorStatusManager.diff.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('DoorStatusManager.enrich.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.Boarding.DoorStatusManager.enrich.success');

            return $this->success('enrich', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('DoorStatusManager.enrich.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.Boarding.DoorStatusManager.enrich.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('DoorStatusManager.normalize.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.Boarding.DoorStatusManager.normalize.success');

            return $this->success('normalize', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('DoorStatusManager.normalize.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.Boarding.DoorStatusManager.normalize.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('DoorStatusManager.aggregate.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.Boarding.DoorStatusManager.aggregate.success');

            return $this->success('aggregate', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('DoorStatusManager.aggregate.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.Boarding.DoorStatusManager.aggregate.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('DoorStatusManager.dispatch.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.Boarding.DoorStatusManager.dispatch.success');

            return $this->success('dispatch', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('DoorStatusManager.dispatch.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.Boarding.DoorStatusManager.dispatch.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('DoorStatusManager.acknowledge.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.Boarding.DoorStatusManager.acknowledge.success');

            return $this->success('acknowledge', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('DoorStatusManager.acknowledge.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.Boarding.DoorStatusManager.acknowledge.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('DoorStatusManager.escalate.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.Boarding.DoorStatusManager.escalate.success');

            return $this->success('escalate', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('DoorStatusManager.escalate.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.Boarding.DoorStatusManager.escalate.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('DoorStatusManager.suppress.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.Boarding.DoorStatusManager.suppress.success');

            return $this->success('suppress', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('DoorStatusManager.suppress.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.Boarding.DoorStatusManager.suppress.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('DoorStatusManager.replay.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.Boarding.DoorStatusManager.replay.success');

            return $this->success('replay', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('DoorStatusManager.replay.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.Boarding.DoorStatusManager.replay.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('DoorStatusManager.hydrate.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.Boarding.DoorStatusManager.hydrate.success');

            return $this->success('hydrate', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('DoorStatusManager.hydrate.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.Boarding.DoorStatusManager.hydrate.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('DoorStatusManager.persist.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.Boarding.DoorStatusManager.persist.success');

            return $this->success('persist', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('DoorStatusManager.persist.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.Boarding.DoorStatusManager.persist.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('DoorStatusManager.invalidate.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.Boarding.DoorStatusManager.invalidate.success');

            return $this->success('invalidate', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('DoorStatusManager.invalidate.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.Boarding.DoorStatusManager.invalidate.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('DoorStatusManager.broadcast.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.Boarding.DoorStatusManager.broadcast.success');

            return $this->success('broadcast', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('DoorStatusManager.broadcast.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.Boarding.DoorStatusManager.broadcast.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('DoorStatusManager.compact.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.Boarding.DoorStatusManager.compact.success');

            return $this->success('compact', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('DoorStatusManager.compact.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.Boarding.DoorStatusManager.compact.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('DoorStatusManager.archiveBatch.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.Boarding.DoorStatusManager.archiveBatch.success');

            return $this->success('archiveBatch', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('DoorStatusManager.archiveBatch.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.Boarding.DoorStatusManager.archiveBatch.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('DoorStatusManager.evaluateRules.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.Boarding.DoorStatusManager.evaluateRules.success');

            return $this->success('evaluateRules', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('DoorStatusManager.evaluateRules.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.Boarding.DoorStatusManager.evaluateRules.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('DoorStatusManager.applyPolicy.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.Boarding.DoorStatusManager.applyPolicy.success');

            return $this->success('applyPolicy', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('DoorStatusManager.applyPolicy.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.Boarding.DoorStatusManager.applyPolicy.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('DoorStatusManager.computeMetrics.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.Boarding.DoorStatusManager.computeMetrics.success');

            return $this->success('computeMetrics', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('DoorStatusManager.computeMetrics.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.Boarding.DoorStatusManager.computeMetrics.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('DoorStatusManager.buildPayload.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.Boarding.DoorStatusManager.buildPayload.success');

            return $this->success('buildPayload', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('DoorStatusManager.buildPayload.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.Boarding.DoorStatusManager.buildPayload.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('DoorStatusManager.transformInput.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.Boarding.DoorStatusManager.transformInput.success');

            return $this->success('transformInput', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('DoorStatusManager.transformInput.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.Boarding.DoorStatusManager.transformInput.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('DoorStatusManager.transformOutput.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.Boarding.DoorStatusManager.transformOutput.success');

            return $this->success('transformOutput', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('DoorStatusManager.transformOutput.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.Boarding.DoorStatusManager.transformOutput.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('DoorStatusManager.checkPreconditions.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.Boarding.DoorStatusManager.checkPreconditions.success');

            return $this->success('checkPreconditions', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('DoorStatusManager.checkPreconditions.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.Boarding.DoorStatusManager.checkPreconditions.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('DoorStatusManager.checkPostconditions.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.Boarding.DoorStatusManager.checkPostconditions.success');

            return $this->success('checkPostconditions', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('DoorStatusManager.checkPostconditions.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.Boarding.DoorStatusManager.checkPostconditions.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('DoorStatusManager.reserveResources.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.Boarding.DoorStatusManager.reserveResources.success');

            return $this->success('reserveResources', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('DoorStatusManager.reserveResources.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.Boarding.DoorStatusManager.reserveResources.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('DoorStatusManager.releaseResources.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.Boarding.DoorStatusManager.releaseResources.success');

            return $this->success('releaseResources', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('DoorStatusManager.releaseResources.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.Boarding.DoorStatusManager.releaseResources.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('DoorStatusManager.lockEntity.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.Boarding.DoorStatusManager.lockEntity.success');

            return $this->success('lockEntity', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('DoorStatusManager.lockEntity.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.Boarding.DoorStatusManager.lockEntity.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('DoorStatusManager.unlockEntity.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.Boarding.DoorStatusManager.unlockEntity.success');

            return $this->success('unlockEntity', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('DoorStatusManager.unlockEntity.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.Boarding.DoorStatusManager.unlockEntity.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('DoorStatusManager.queueFollowUp.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.Boarding.DoorStatusManager.queueFollowUp.success');

            return $this->success('queueFollowUp', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('DoorStatusManager.queueFollowUp.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.Boarding.DoorStatusManager.queueFollowUp.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('DoorStatusManager.scheduleRetry.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.Boarding.DoorStatusManager.scheduleRetry.success');

            return $this->success('scheduleRetry', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('DoorStatusManager.scheduleRetry.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.Boarding.DoorStatusManager.scheduleRetry.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('DoorStatusManager.markComplete.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.Boarding.DoorStatusManager.markComplete.success');

            return $this->success('markComplete', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('DoorStatusManager.markComplete.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.Boarding.DoorStatusManager.markComplete.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('DoorStatusManager.markFailed.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.Boarding.DoorStatusManager.markFailed.success');

            return $this->success('markFailed', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('DoorStatusManager.markFailed.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.Boarding.DoorStatusManager.markFailed.failure');
    ...
    {
        $cacheKey = sprintf('domain:Boarding:DoorStatusManager:%s:%s', $verb, md5(json_encode($context['payload'])));
    ...
    protected function buildRecommendations(string $verb, float $score, array $payload): array
    {
        $recs = [];
        if ($score > 100) {
            $recs[] = ['code' => 'HIGH_LOAD', 'message' => 'High operational load detected for DoorStatusManager'];
        }
    ...
    protected function afterHook(string $verb, array $context, array $result): void
    {
        if (in_array($verb, ['publish', 'broadcast', 'escalate'], true)) {
            $this->logger->info('DoorStatusManager.after.'.$verb, [
                'correlation_id' => $context['correlation_id'],
