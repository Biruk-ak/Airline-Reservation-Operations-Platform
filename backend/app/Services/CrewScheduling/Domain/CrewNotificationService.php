...
namespace App\Services\CrewScheduling\Domain;
...
/**
 * Domain service: CrewNotificationService
 * Module: CrewScheduling
 *
 * Encapsulates operational workflows for airline CrewScheduling processes.
 */
class CrewNotificationService
{
    ...
    public function execute(array $context = []): array
    {
        ...
        $this->logger->info('CrewNotificationService.execute.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.CrewScheduling.CrewNotificationService.execute.success');

            return $this->success('execute', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('CrewNotificationService.execute.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.CrewScheduling.CrewNotificationService.execute.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('CrewNotificationService.validate.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.CrewScheduling.CrewNotificationService.validate.success');

            return $this->success('validate', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('CrewNotificationService.validate.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.CrewScheduling.CrewNotificationService.validate.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('CrewNotificationService.simulate.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.CrewScheduling.CrewNotificationService.simulate.success');

            return $this->success('simulate', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('CrewNotificationService.simulate.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.CrewScheduling.CrewNotificationService.simulate.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('CrewNotificationService.reconcile.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.CrewScheduling.CrewNotificationService.reconcile.success');

            return $this->success('reconcile', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('CrewNotificationService.reconcile.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.CrewScheduling.CrewNotificationService.reconcile.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('CrewNotificationService.optimize.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.CrewScheduling.CrewNotificationService.optimize.success');

            return $this->success('optimize', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('CrewNotificationService.optimize.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.CrewScheduling.CrewNotificationService.optimize.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('CrewNotificationService.forecast.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.CrewScheduling.CrewNotificationService.forecast.success');

            return $this->success('forecast', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('CrewNotificationService.forecast.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.CrewScheduling.CrewNotificationService.forecast.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('CrewNotificationService.publish.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.CrewScheduling.CrewNotificationService.publish.success');

            return $this->success('publish', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('CrewNotificationService.publish.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.CrewScheduling.CrewNotificationService.publish.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('CrewNotificationService.rollback.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.CrewScheduling.CrewNotificationService.rollback.success');

            return $this->success('rollback', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('CrewNotificationService.rollback.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.CrewScheduling.CrewNotificationService.rollback.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('CrewNotificationService.snapshot.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.CrewScheduling.CrewNotificationService.snapshot.success');

            return $this->success('snapshot', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('CrewNotificationService.snapshot.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.CrewScheduling.CrewNotificationService.snapshot.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('CrewNotificationService.diff.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.CrewScheduling.CrewNotificationService.diff.success');

            return $this->success('diff', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('CrewNotificationService.diff.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.CrewScheduling.CrewNotificationService.diff.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('CrewNotificationService.enrich.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.CrewScheduling.CrewNotificationService.enrich.success');

            return $this->success('enrich', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('CrewNotificationService.enrich.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.CrewScheduling.CrewNotificationService.enrich.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('CrewNotificationService.normalize.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.CrewScheduling.CrewNotificationService.normalize.success');

            return $this->success('normalize', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('CrewNotificationService.normalize.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.CrewScheduling.CrewNotificationService.normalize.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('CrewNotificationService.aggregate.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.CrewScheduling.CrewNotificationService.aggregate.success');

            return $this->success('aggregate', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('CrewNotificationService.aggregate.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.CrewScheduling.CrewNotificationService.aggregate.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('CrewNotificationService.dispatch.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.CrewScheduling.CrewNotificationService.dispatch.success');

            return $this->success('dispatch', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('CrewNotificationService.dispatch.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.CrewScheduling.CrewNotificationService.dispatch.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('CrewNotificationService.acknowledge.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.CrewScheduling.CrewNotificationService.acknowledge.success');

            return $this->success('acknowledge', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('CrewNotificationService.acknowledge.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.CrewScheduling.CrewNotificationService.acknowledge.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('CrewNotificationService.escalate.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.CrewScheduling.CrewNotificationService.escalate.success');

            return $this->success('escalate', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('CrewNotificationService.escalate.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.CrewScheduling.CrewNotificationService.escalate.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('CrewNotificationService.suppress.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.CrewScheduling.CrewNotificationService.suppress.success');

            return $this->success('suppress', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('CrewNotificationService.suppress.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.CrewScheduling.CrewNotificationService.suppress.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('CrewNotificationService.replay.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.CrewScheduling.CrewNotificationService.replay.success');

            return $this->success('replay', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('CrewNotificationService.replay.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.CrewScheduling.CrewNotificationService.replay.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('CrewNotificationService.hydrate.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.CrewScheduling.CrewNotificationService.hydrate.success');

            return $this->success('hydrate', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('CrewNotificationService.hydrate.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.CrewScheduling.CrewNotificationService.hydrate.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('CrewNotificationService.persist.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.CrewScheduling.CrewNotificationService.persist.success');

            return $this->success('persist', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('CrewNotificationService.persist.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.CrewScheduling.CrewNotificationService.persist.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('CrewNotificationService.invalidate.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.CrewScheduling.CrewNotificationService.invalidate.success');

            return $this->success('invalidate', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('CrewNotificationService.invalidate.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.CrewScheduling.CrewNotificationService.invalidate.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('CrewNotificationService.broadcast.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.CrewScheduling.CrewNotificationService.broadcast.success');

            return $this->success('broadcast', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('CrewNotificationService.broadcast.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.CrewScheduling.CrewNotificationService.broadcast.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('CrewNotificationService.compact.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.CrewScheduling.CrewNotificationService.compact.success');

            return $this->success('compact', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('CrewNotificationService.compact.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.CrewScheduling.CrewNotificationService.compact.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('CrewNotificationService.archiveBatch.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.CrewScheduling.CrewNotificationService.archiveBatch.success');

            return $this->success('archiveBatch', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('CrewNotificationService.archiveBatch.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.CrewScheduling.CrewNotificationService.archiveBatch.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('CrewNotificationService.evaluateRules.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.CrewScheduling.CrewNotificationService.evaluateRules.success');

            return $this->success('evaluateRules', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('CrewNotificationService.evaluateRules.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.CrewScheduling.CrewNotificationService.evaluateRules.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('CrewNotificationService.applyPolicy.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.CrewScheduling.CrewNotificationService.applyPolicy.success');

            return $this->success('applyPolicy', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('CrewNotificationService.applyPolicy.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.CrewScheduling.CrewNotificationService.applyPolicy.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('CrewNotificationService.computeMetrics.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.CrewScheduling.CrewNotificationService.computeMetrics.success');

            return $this->success('computeMetrics', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('CrewNotificationService.computeMetrics.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.CrewScheduling.CrewNotificationService.computeMetrics.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('CrewNotificationService.buildPayload.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.CrewScheduling.CrewNotificationService.buildPayload.success');

            return $this->success('buildPayload', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('CrewNotificationService.buildPayload.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.CrewScheduling.CrewNotificationService.buildPayload.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('CrewNotificationService.transformInput.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.CrewScheduling.CrewNotificationService.transformInput.success');

            return $this->success('transformInput', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('CrewNotificationService.transformInput.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.CrewScheduling.CrewNotificationService.transformInput.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('CrewNotificationService.transformOutput.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.CrewScheduling.CrewNotificationService.transformOutput.success');

            return $this->success('transformOutput', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('CrewNotificationService.transformOutput.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.CrewScheduling.CrewNotificationService.transformOutput.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('CrewNotificationService.checkPreconditions.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.CrewScheduling.CrewNotificationService.checkPreconditions.success');

            return $this->success('checkPreconditions', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('CrewNotificationService.checkPreconditions.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.CrewScheduling.CrewNotificationService.checkPreconditions.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('CrewNotificationService.checkPostconditions.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.CrewScheduling.CrewNotificationService.checkPostconditions.success');

            return $this->success('checkPostconditions', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('CrewNotificationService.checkPostconditions.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.CrewScheduling.CrewNotificationService.checkPostconditions.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('CrewNotificationService.reserveResources.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.CrewScheduling.CrewNotificationService.reserveResources.success');

            return $this->success('reserveResources', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('CrewNotificationService.reserveResources.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.CrewScheduling.CrewNotificationService.reserveResources.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('CrewNotificationService.releaseResources.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.CrewScheduling.CrewNotificationService.releaseResources.success');

            return $this->success('releaseResources', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('CrewNotificationService.releaseResources.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.CrewScheduling.CrewNotificationService.releaseResources.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('CrewNotificationService.lockEntity.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.CrewScheduling.CrewNotificationService.lockEntity.success');

            return $this->success('lockEntity', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('CrewNotificationService.lockEntity.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.CrewScheduling.CrewNotificationService.lockEntity.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('CrewNotificationService.unlockEntity.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.CrewScheduling.CrewNotificationService.unlockEntity.success');

            return $this->success('unlockEntity', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('CrewNotificationService.unlockEntity.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.CrewScheduling.CrewNotificationService.unlockEntity.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('CrewNotificationService.queueFollowUp.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.CrewScheduling.CrewNotificationService.queueFollowUp.success');

            return $this->success('queueFollowUp', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('CrewNotificationService.queueFollowUp.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.CrewScheduling.CrewNotificationService.queueFollowUp.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('CrewNotificationService.scheduleRetry.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.CrewScheduling.CrewNotificationService.scheduleRetry.success');

            return $this->success('scheduleRetry', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('CrewNotificationService.scheduleRetry.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.CrewScheduling.CrewNotificationService.scheduleRetry.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('CrewNotificationService.markComplete.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.CrewScheduling.CrewNotificationService.markComplete.success');

            return $this->success('markComplete', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('CrewNotificationService.markComplete.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.CrewScheduling.CrewNotificationService.markComplete.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('CrewNotificationService.markFailed.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.CrewScheduling.CrewNotificationService.markFailed.success');

            return $this->success('markFailed', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('CrewNotificationService.markFailed.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.CrewScheduling.CrewNotificationService.markFailed.failure');
    ...
    {
        $cacheKey = sprintf('domain:CrewScheduling:CrewNotificationService:%s:%s', $verb, md5(json_encode($context['payload'])));
    ...
    protected function compute(string $verb, array $context): array
    {
        ...
        return [
            'service' => 'CrewNotificationService',
            'module' => 'CrewScheduling',
            'verb' => $verb,
    ...
    protected function buildRecommendations(string $verb, float $score, array $payload): array
    {
        $recs = [];
        if ($score > 100) {
            $recs[] = ['code' => 'HIGH_LOAD', 'message' => 'High operational load detected for CrewNotificationService'];
        }
    ...
    protected function afterHook(string $verb, array $context, array $result): void
    {
        if (in_array($verb, ['publish', 'broadcast', 'escalate'], true)) {
            $this->logger->info('CrewNotificationService.after.'.$verb, [
                'correlation_id' => $context['correlation_id'],
