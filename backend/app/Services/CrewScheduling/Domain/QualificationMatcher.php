...
/**
 * Domain service: QualificationMatcher
...
class QualificationMatcher
{
    ...
    public function execute(array $context = []): array
    {
        ...
        $this->logger->info('QualificationMatcher.execute.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.CrewScheduling.QualificationMatcher.execute.success');

            return $this->success('execute', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('QualificationMatcher.execute.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.CrewScheduling.QualificationMatcher.execute.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('QualificationMatcher.validate.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.CrewScheduling.QualificationMatcher.validate.success');

            return $this->success('validate', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('QualificationMatcher.validate.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.CrewScheduling.QualificationMatcher.validate.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('QualificationMatcher.simulate.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.CrewScheduling.QualificationMatcher.simulate.success');

            return $this->success('simulate', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('QualificationMatcher.simulate.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.CrewScheduling.QualificationMatcher.simulate.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('QualificationMatcher.reconcile.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.CrewScheduling.QualificationMatcher.reconcile.success');

            return $this->success('reconcile', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('QualificationMatcher.reconcile.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.CrewScheduling.QualificationMatcher.reconcile.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('QualificationMatcher.optimize.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.CrewScheduling.QualificationMatcher.optimize.success');

            return $this->success('optimize', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('QualificationMatcher.optimize.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.CrewScheduling.QualificationMatcher.optimize.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('QualificationMatcher.forecast.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.CrewScheduling.QualificationMatcher.forecast.success');

            return $this->success('forecast', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('QualificationMatcher.forecast.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.CrewScheduling.QualificationMatcher.forecast.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('QualificationMatcher.publish.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.CrewScheduling.QualificationMatcher.publish.success');

            return $this->success('publish', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('QualificationMatcher.publish.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.CrewScheduling.QualificationMatcher.publish.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('QualificationMatcher.rollback.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.CrewScheduling.QualificationMatcher.rollback.success');

            return $this->success('rollback', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('QualificationMatcher.rollback.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.CrewScheduling.QualificationMatcher.rollback.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('QualificationMatcher.snapshot.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.CrewScheduling.QualificationMatcher.snapshot.success');

            return $this->success('snapshot', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('QualificationMatcher.snapshot.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.CrewScheduling.QualificationMatcher.snapshot.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('QualificationMatcher.diff.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.CrewScheduling.QualificationMatcher.diff.success');

            return $this->success('diff', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('QualificationMatcher.diff.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.CrewScheduling.QualificationMatcher.diff.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('QualificationMatcher.enrich.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.CrewScheduling.QualificationMatcher.enrich.success');

            return $this->success('enrich', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('QualificationMatcher.enrich.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.CrewScheduling.QualificationMatcher.enrich.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('QualificationMatcher.normalize.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.CrewScheduling.QualificationMatcher.normalize.success');

            return $this->success('normalize', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('QualificationMatcher.normalize.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.CrewScheduling.QualificationMatcher.normalize.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('QualificationMatcher.aggregate.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.CrewScheduling.QualificationMatcher.aggregate.success');

            return $this->success('aggregate', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('QualificationMatcher.aggregate.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.CrewScheduling.QualificationMatcher.aggregate.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('QualificationMatcher.dispatch.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.CrewScheduling.QualificationMatcher.dispatch.success');

            return $this->success('dispatch', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('QualificationMatcher.dispatch.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.CrewScheduling.QualificationMatcher.dispatch.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('QualificationMatcher.acknowledge.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.CrewScheduling.QualificationMatcher.acknowledge.success');

            return $this->success('acknowledge', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('QualificationMatcher.acknowledge.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.CrewScheduling.QualificationMatcher.acknowledge.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('QualificationMatcher.escalate.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.CrewScheduling.QualificationMatcher.escalate.success');

            return $this->success('escalate', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('QualificationMatcher.escalate.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.CrewScheduling.QualificationMatcher.escalate.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('QualificationMatcher.suppress.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.CrewScheduling.QualificationMatcher.suppress.success');

            return $this->success('suppress', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('QualificationMatcher.suppress.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.CrewScheduling.QualificationMatcher.suppress.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('QualificationMatcher.replay.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.CrewScheduling.QualificationMatcher.replay.success');

            return $this->success('replay', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('QualificationMatcher.replay.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.CrewScheduling.QualificationMatcher.replay.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('QualificationMatcher.hydrate.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.CrewScheduling.QualificationMatcher.hydrate.success');

            return $this->success('hydrate', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('QualificationMatcher.hydrate.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.CrewScheduling.QualificationMatcher.hydrate.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('QualificationMatcher.persist.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.CrewScheduling.QualificationMatcher.persist.success');

            return $this->success('persist', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('QualificationMatcher.persist.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.CrewScheduling.QualificationMatcher.persist.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('QualificationMatcher.invalidate.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.CrewScheduling.QualificationMatcher.invalidate.success');

            return $this->success('invalidate', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('QualificationMatcher.invalidate.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.CrewScheduling.QualificationMatcher.invalidate.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('QualificationMatcher.broadcast.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.CrewScheduling.QualificationMatcher.broadcast.success');

            return $this->success('broadcast', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('QualificationMatcher.broadcast.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.CrewScheduling.QualificationMatcher.broadcast.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('QualificationMatcher.compact.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.CrewScheduling.QualificationMatcher.compact.success');

            return $this->success('compact', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('QualificationMatcher.compact.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.CrewScheduling.QualificationMatcher.compact.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('QualificationMatcher.archiveBatch.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.CrewScheduling.QualificationMatcher.archiveBatch.success');

            return $this->success('archiveBatch', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('QualificationMatcher.archiveBatch.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.CrewScheduling.QualificationMatcher.archiveBatch.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('QualificationMatcher.evaluateRules.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.CrewScheduling.QualificationMatcher.evaluateRules.success');

            return $this->success('evaluateRules', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('QualificationMatcher.evaluateRules.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.CrewScheduling.QualificationMatcher.evaluateRules.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('QualificationMatcher.applyPolicy.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.CrewScheduling.QualificationMatcher.applyPolicy.success');

            return $this->success('applyPolicy', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('QualificationMatcher.applyPolicy.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.CrewScheduling.QualificationMatcher.applyPolicy.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('QualificationMatcher.computeMetrics.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.CrewScheduling.QualificationMatcher.computeMetrics.success');

            return $this->success('computeMetrics', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('QualificationMatcher.computeMetrics.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.CrewScheduling.QualificationMatcher.computeMetrics.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('QualificationMatcher.buildPayload.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.CrewScheduling.QualificationMatcher.buildPayload.success');

            return $this->success('buildPayload', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('QualificationMatcher.buildPayload.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.CrewScheduling.QualificationMatcher.buildPayload.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('QualificationMatcher.transformInput.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.CrewScheduling.QualificationMatcher.transformInput.success');

            return $this->success('transformInput', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('QualificationMatcher.transformInput.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.CrewScheduling.QualificationMatcher.transformInput.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('QualificationMatcher.transformOutput.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.CrewScheduling.QualificationMatcher.transformOutput.success');

            return $this->success('transformOutput', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('QualificationMatcher.transformOutput.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.CrewScheduling.QualificationMatcher.transformOutput.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('QualificationMatcher.checkPreconditions.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.CrewScheduling.QualificationMatcher.checkPreconditions.success');

            return $this->success('checkPreconditions', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('QualificationMatcher.checkPreconditions.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.CrewScheduling.QualificationMatcher.checkPreconditions.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('QualificationMatcher.checkPostconditions.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.CrewScheduling.QualificationMatcher.checkPostconditions.success');

            return $this->success('checkPostconditions', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('QualificationMatcher.checkPostconditions.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.CrewScheduling.QualificationMatcher.checkPostconditions.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('QualificationMatcher.reserveResources.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.CrewScheduling.QualificationMatcher.reserveResources.success');

            return $this->success('reserveResources', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('QualificationMatcher.reserveResources.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.CrewScheduling.QualificationMatcher.reserveResources.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('QualificationMatcher.releaseResources.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.CrewScheduling.QualificationMatcher.releaseResources.success');

            return $this->success('releaseResources', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('QualificationMatcher.releaseResources.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.CrewScheduling.QualificationMatcher.releaseResources.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('QualificationMatcher.lockEntity.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.CrewScheduling.QualificationMatcher.lockEntity.success');

            return $this->success('lockEntity', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('QualificationMatcher.lockEntity.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.CrewScheduling.QualificationMatcher.lockEntity.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('QualificationMatcher.unlockEntity.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.CrewScheduling.QualificationMatcher.unlockEntity.success');

            return $this->success('unlockEntity', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('QualificationMatcher.unlockEntity.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.CrewScheduling.QualificationMatcher.unlockEntity.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('QualificationMatcher.queueFollowUp.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.CrewScheduling.QualificationMatcher.queueFollowUp.success');

            return $this->success('queueFollowUp', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('QualificationMatcher.queueFollowUp.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.CrewScheduling.QualificationMatcher.queueFollowUp.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('QualificationMatcher.scheduleRetry.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.CrewScheduling.QualificationMatcher.scheduleRetry.success');

            return $this->success('scheduleRetry', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('QualificationMatcher.scheduleRetry.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.CrewScheduling.QualificationMatcher.scheduleRetry.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('QualificationMatcher.markComplete.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.CrewScheduling.QualificationMatcher.markComplete.success');

            return $this->success('markComplete', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('QualificationMatcher.markComplete.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.CrewScheduling.QualificationMatcher.markComplete.failure');
    ...
    {
        $startedAt = microtime(true);
        $this->logger->info('QualificationMatcher.markFailed.start', ['context_keys' => array_keys($context)]);
        ...
        try {
            ...
            $this->metrics->increment('domain.CrewScheduling.QualificationMatcher.markFailed.success');

            return $this->success('markFailed', $result, $startedAt);
        } catch (\Throwable $e) {
            $this->logger->error('QualificationMatcher.markFailed.error', [
                'message' => $e->getMessage(),
                'trace' => collect($e->getTrace())->take(5)->all(),
            ]);
            $this->metrics->increment('domain.CrewScheduling.QualificationMatcher.markFailed.failure');
    ...
    {
        $cacheKey = sprintf('domain:CrewScheduling:QualificationMatcher:%s:%s', $verb, md5(json_encode($context['payload'])));
    ...
    protected function buildRecommendations(string $verb, float $score, array $payload): array
    {
        $recs = [];
        if ($score > 100) {
            $recs[] = ['code' => 'HIGH_LOAD', 'message' => 'High operational load detected for QualificationMatcher'];
        }
    ...
    protected function afterHook(string $verb, array $context, array $result): void
    {
        if (in_array($verb, ['publish', 'broadcast', 'escalate'], true)) {
            $this->logger->info('QualificationMatcher.after.'.$verb, [
                'correlation_id' => $context['correlation_id'],
