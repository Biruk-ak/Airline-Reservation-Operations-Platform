...
use App\Http\Requests\Cargo\StoreCargoShipmentRequest;
use App\Http\Requests\Cargo\UpdateCargoShipmentRequest;
use App\Http\Requests\Cargo\SearchCargoShipmentRequest;
use App\Http\Requests\Cargo\BulkCargoShipmentRequest;
...
{
    public function __construct(private CargoShipmentService $service)
    {
        $this->middleware('auth:sanctum');
        $this->middleware('airline.scope');
    }

    public function index(SearchCargoShipmentRequest $request): JsonResponse
    {
    ...
    public function store(StoreCargoShipmentRequest $request): JsonResponse
    {
        ...
        return response()->json([
            'message' => 'CargoShipment created successfully',
    ...
    public function show(Request $request, int $id): JsonResponse
    {
        ...
        if (!$entity) {
            return response()->json(['message' => 'CargoShipment not found'], 404);
        }
    ...
    public function update(UpdateCargoShipmentRequest $request, int $id): JsonResponse
    {
        $entity = $this->service->findForAirline($id, $request->attributes->get('airline_id'));
        if (!$entity) {
            return response()->json(['message' => 'CargoShipment not found'], 404);
        ...
        return response()->json([
            'message' => 'CargoShipment updated successfully',
    ...
    public function destroy(Request $request, int $id): JsonResponse
    {
        ...
        return response()->json(['message' => 'CargoShipment deleted successfully']);
    }
    ...
    public function bulk(BulkCargoShipmentRequest $request): JsonResponse
    {
    ...
    public function syncExternal(Request $request, int $id): JsonResponse
    {
        ...
        Log::info('CargoShipment external sync', ['id' => $id, 'user' => $request->user()->id]);
        return response()->json(['data' => $synced->toOperationalSummary()]);
    }

    public function export(SearchCargoShipmentRequest $request): JsonResponse
    {
        $filters = $request->validated();
        $filters['airline_id'] = $request->attributes->get('airline_id');
