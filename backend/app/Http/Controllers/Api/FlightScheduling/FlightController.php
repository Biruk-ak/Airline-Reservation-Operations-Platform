...
namespace App\Http\Controllers\Api\FlightScheduling;

use App\Http\Controllers\Controller;
use App\Models\FlightScheduling\Flight;
use App\Services\FlightScheduling\FlightService;
use App\Http\Requests\FlightScheduling\StoreFlightRequest;
use App\Http\Requests\FlightScheduling\UpdateFlightRequest;
use App\Http\Requests\FlightScheduling\SearchFlightRequest;
use App\Http\Requests\FlightScheduling\BulkFlightRequest;
...
class FlightController extends Controller
{
    ...
    public function index(SearchFlightRequest $request): JsonResponse
    {
    ...
    public function bulk(BulkFlightRequest $request): JsonResponse
    {
    ...
    public function syncExternal(Request $request, int $id): JsonResponse
    {
        ...
        Log::info('Flight external sync', ['id' => $id, 'user' => $request->user()->id]);
        return response()->json(['data' => $synced->toOperationalSummary()]);
    }

    public function export(SearchFlightRequest $request): JsonResponse
    {
        $filters = $request->validated();
        $filters['airline_id'] = $request->attributes->get('airline_id');
