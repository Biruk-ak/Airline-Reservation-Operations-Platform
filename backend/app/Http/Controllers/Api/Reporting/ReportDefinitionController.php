...
use App\Http\Requests\Reporting\SearchReportDefinitionRequest;
use App\Http\Requests\Reporting\BulkReportDefinitionRequest;
...
{
    public function __construct(private ReportDefinitionService $service)
    {
        $this->middleware('auth:sanctum');
        $this->middleware('airline.scope');
    }

    public function index(SearchReportDefinitionRequest $request): JsonResponse
    {
    ...
    public function store(StoreReportDefinitionRequest $request): JsonResponse
    {
        ...
        return response()->json([
            'message' => 'ReportDefinition created successfully',
    ...
    public function show(Request $request, int $id): JsonResponse
    {
        ...
        if (!$entity) {
            return response()->json(['message' => 'ReportDefinition not found'], 404);
        }
    ...
    public function update(UpdateReportDefinitionRequest $request, int $id): JsonResponse
    {
        $entity = $this->service->findForAirline($id, $request->attributes->get('airline_id'));
        if (!$entity) {
            return response()->json(['message' => 'ReportDefinition not found'], 404);
        ...
        return response()->json([
            'message' => 'ReportDefinition updated successfully',
    ...
    public function destroy(Request $request, int $id): JsonResponse
    {
        ...
        return response()->json(['message' => 'ReportDefinition deleted successfully']);
    }
    ...
    public function bulk(BulkReportDefinitionRequest $request): JsonResponse
    {
    ...
    public function syncExternal(Request $request, int $id): JsonResponse
    {
        ...
        Log::info('ReportDefinition external sync', ['id' => $id, 'user' => $request->user()->id]);
        return response()->json(['data' => $synced->toOperationalSummary()]);
    }

    public function export(SearchReportDefinitionRequest $request): JsonResponse
    {
        $filters = $request->validated();
        $filters['airline_id'] = $request->attributes->get('airline_id');
