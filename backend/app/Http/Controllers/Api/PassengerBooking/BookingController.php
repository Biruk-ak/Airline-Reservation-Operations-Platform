...
namespace App\Http\Controllers\Api\PassengerBooking;

use App\Http\Controllers\Controller;
use App\Models\PassengerBooking\Booking;
use App\Services\PassengerBooking\BookingService;
use App\Http\Requests\PassengerBooking\StoreBookingRequest;
use App\Http\Requests\PassengerBooking\UpdateBookingRequest;
use App\Http\Requests\PassengerBooking\SearchBookingRequest;
use App\Http\Requests\PassengerBooking\BulkBookingRequest;
...
class BookingController extends Controller
{
    ...
    public function index(SearchBookingRequest $request): JsonResponse
    {
    ...
    public function bulk(BulkBookingRequest $request): JsonResponse
    {
    ...
    public function syncExternal(Request $request, int $id): JsonResponse
    {
        ...
        Log::info('Booking external sync', ['id' => $id, 'user' => $request->user()->id]);
        return response()->json(['data' => $synced->toOperationalSummary()]);
    }

    public function export(SearchBookingRequest $request): JsonResponse
    {
        $filters = $request->validated();
        $filters['airline_id'] = $request->attributes->get('airline_id');
