...
namespace App\Http\Controllers\Api\SeatSelection;

use App\Http\Controllers\Controller;
use App\Models\SeatSelection\SeatMap;
use App\Services\SeatSelection\SeatMapService;
use App\Http\Requests\SeatSelection\StoreSeatMapRequest;
use App\Http\Requests\SeatSelection\UpdateSeatMapRequest;
use App\Http\Requests\SeatSelection\SearchSeatMapRequest;
use App\Http\Requests\SeatSelection\BulkSeatMapRequest;
...
{
    public function __construct(private SeatMapService $service)
    {
        $this->middleware('auth:sanctum');
        $this->middleware('airline.scope');
    }

    public function index(SearchSeatMapRequest $request): JsonResponse
    {
    ...
    public function show(Request $request, int $id): JsonResponse
    {
        ...
        if (!$entity) {
            return response()->json(['message' => 'SeatMap not found'], 404);
        }
    ...
    public function destroy(Request $request, int $id): JsonResponse
    {
        ...
        return response()->json(['message' => 'SeatMap deleted successfully']);
    }
    ...
    public function bulk(BulkSeatMapRequest $request): JsonResponse
    {
    ...
    public function syncExternal(Request $request, int $id): JsonResponse
    {
        ...
        Log::info('SeatMap external sync', ['id' => $id, 'user' => $request->user()->id]);
        return response()->json(['data' => $synced->toOperationalSummary()]);
    }

    public function export(SearchSeatMapRequest $request): JsonResponse
    {
        $filters = $request->validated();
        $filters['airline_id'] = $request->attributes->get('airline_id');
