...
namespace App\Http\Controllers\Api\CrewScheduling;

use App\Http\Controllers\Controller;
use App\Models\CrewScheduling\CrewMember;
use App\Services\CrewScheduling\CrewMemberService;
use App\Http\Requests\CrewScheduling\StoreCrewMemberRequest;
use App\Http\Requests\CrewScheduling\UpdateCrewMemberRequest;
use App\Http\Requests\CrewScheduling\SearchCrewMemberRequest;
use App\Http\Requests\CrewScheduling\BulkCrewMemberRequest;
...
class CrewMemberController extends Controller
{
    ...
    public function index(SearchCrewMemberRequest $request): JsonResponse
    {
    ...
    public function store(StoreCrewMemberRequest $request): JsonResponse
    {
        ...
        return response()->json([
            'message' => 'CrewMember created successfully',
    ...
    public function show(Request $request, int $id): JsonResponse
    {
        ...
        if (!$entity) {
            return response()->json(['message' => 'CrewMember not found'], 404);
        }
    ...
    public function update(UpdateCrewMemberRequest $request, int $id): JsonResponse
    {
        $entity = $this->service->findForAirline($id, $request->attributes->get('airline_id'));
        if (!$entity) {
            return response()->json(['message' => 'CrewMember not found'], 404);
        ...
        return response()->json([
            'message' => 'CrewMember updated successfully',
    ...
    public function destroy(Request $request, int $id): JsonResponse
    {
        ...
        return response()->json(['message' => 'CrewMember deleted successfully']);
    }
    ...
    public function bulk(BulkCrewMemberRequest $request): JsonResponse
    {
    ...
    public function syncExternal(Request $request, int $id): JsonResponse
    {
        ...
        Log::info('CrewMember external sync', ['id' => $id, 'user' => $request->user()->id]);
        return response()->json(['data' => $synced->toOperationalSummary()]);
    }

    public function export(SearchCrewMemberRequest $request): JsonResponse
    {
        $filters = $request->validated();
        $filters['airline_id'] = $request->attributes->get('airline_id');
