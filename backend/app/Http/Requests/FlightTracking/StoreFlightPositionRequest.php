<?php
namespace App\Http\Requests\FlightTracking;
use Illuminate\Foundation\Http\FormRequest;
class StoreFlightPositionRequest extends FormRequest
{
    ...
    {
        return [
            'name.required' => 'A display name is required for FlightPosition.',
