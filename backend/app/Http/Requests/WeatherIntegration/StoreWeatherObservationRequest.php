<?php
namespace App\Http\Requests\WeatherIntegration;
use Illuminate\Foundation\Http\FormRequest;
class StoreWeatherObservationRequest extends FormRequest
{
    ...
    {
        return [
            'name.required' => 'A display name is required for WeatherObservation.',
